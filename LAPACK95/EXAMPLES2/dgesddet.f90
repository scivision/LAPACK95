...
!  .. EXECUTABLE STATEMENTS ..
   WRITE (NOUT,*) 'DGESDD ET_Example Program Results.'
...
!
   WRITE ( NOUT, * )'---------------------------------------------------------'
   WRITE ( NOUT, * )
   WRITE ( NOUT, * )'Details of LA_DGESDD LAPACK Subroutine Results.'
   WRITE ( NOUT, * )
!
   WRITE(NOUT,*)
...
! ERROR 6
   ...
   WRITE(NOUT,*) 'INFO = ', INFO
!
END PROGRAM LA_DGESDD_ET_EXAMPLE
