...
!  .. EXECUTABLE STATEMENTS ..
   WRITE (NOUT,*) 'CPPSVX ET_Example Program Results.'
...
!
   WRITE ( NOUT, * )'---------------------------------------------------------'
   WRITE ( NOUT, * )
   WRITE ( NOUT, * )'Details of LA_CPPSVX LAPACK Subroutine Results.'
   WRITE ( NOUT, * )
!
   WRITE(NOUT,*)
...
!
   ...
   WRITE(NOUT,*)'   X - the solution vectors computed by LA_PPSVX, INFO = ', INFO
   WRITE (NOUT,FMT) X(1:N,1)
END PROGRAM LA_CPPSVX_ET_EXAMPLE
