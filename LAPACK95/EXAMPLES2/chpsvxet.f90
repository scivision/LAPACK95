...
!  .. EXECUTABLE STATEMENTS ..
   WRITE (NOUT,*) 'CHPSVX ET_Example Program Results.'
...
!
   WRITE ( NOUT, * )'---------------------------------------------------------'
   WRITE ( NOUT, * )
   WRITE ( NOUT, * )'Details of LA_CHPSVX LAPACK Subroutine Results.'
   WRITE ( NOUT, * )
!
   WRITE(NOUT,*)
...
!
   ...
   WRITE(NOUT,*) 'RCOND = ', RCOND
!
END PROGRAM LA_CHPSVX_ET_EXAMPLE
