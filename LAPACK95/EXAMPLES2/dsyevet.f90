...
!  .. EXECUTABLE STATEMENTS ..
   WRITE(NOUT,*) 'DSYEV ET_Example Program Results.'
...
!
   WRITE(NOUT,*) '---------------------------------------------------------'
   WRITE(NOUT,*)
   WRITE ( NOUT, * )'Details of LA_DSYEV LAPACK Subroutine Results.'
   WRITE(NOUT,*)
!
   WRITE(NOUT,*)
...
! 
   ...
   END DO
! 
END PROGRAM LA_DSYEV_ET_EXAMPLE
