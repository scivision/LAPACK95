...
!
   WRITE(NOUT,*) 'ZHEEVD ET_Example Program Results.'
...
!
   WRITE(NOUT,*) '---------------------------------------------------------'
   WRITE(NOUT,*)
   WRITE ( NOUT, * )'Details of LA_ZHEEVD LAPACK Subroutine Results.'
   WRITE(NOUT,*)
!
   WRITE(NOUT,*)
...
! 
   ...
   WRITE(NOUT,FMT) W(:)
! 
END PROGRAM LA_ZHEEVD_ET_EXAMPLE
