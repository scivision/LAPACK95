...
!  .. EXECUTABLE STATEMENTS ..
   WRITE (NOUT,*) 'ZSPSVX ET_Example Program Results.'
...
!
   WRITE ( NOUT, * )'---------------------------------------------------------'
   WRITE ( NOUT, * )
   WRITE ( NOUT, * )'Details of LA_ZSPSVX LAPACK Subroutine Results.'
   WRITE ( NOUT, * )
!
   WRITE(NOUT,*)
...
!
   ...
   WRITE(NOUT,*) 'RCOND = ', RCOND
!
END PROGRAM LA_ZSPSVX_ET_EXAMPLE
