...
!  .. EXECUTABLE STATEMENTS ..
   WRITE (NOUT,*) 'ZHPSVX ET_Example Program Results.'
...
!
   WRITE ( NOUT, * )'---------------------------------------------------------'
   WRITE ( NOUT, * )
   WRITE ( NOUT, * )'Details of LA_ZHPSVX LAPACK Subroutine Results.'
   WRITE ( NOUT, * )
!
   WRITE(NOUT,*)
...
!
   ...
   WRITE(NOUT,*) 'RCOND = ', RCOND
!
END PROGRAM LA_ZHPSVX_ET_EXAMPLE
