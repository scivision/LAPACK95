...
!  .. EXECUTABLE STATEMENTS ..
   WRITE (NOUT,*) 'DPBSVX ET_Example Program Results.'
...
!
   WRITE ( NOUT, * )'---------------------------------------------------------'
   WRITE ( NOUT, * )
   WRITE ( NOUT, * )'Details of LA_DPBSVX LAPACK Subroutine Results.'
   WRITE ( NOUT, * )
!
   WRITE(NOUT,*)
...
!
   ...
   WRITE (NOUT,FMT) X(1:N,1)
!
END PROGRAM LA_DPBSVX_ET_EXAMPLE
