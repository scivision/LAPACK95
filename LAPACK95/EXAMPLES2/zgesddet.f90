...
!  .. EXECUTABLE STATEMENTS ..
   WRITE (NOUT,*) 'ZGESDD ET_Example Program Results.'
...
!
   WRITE ( NOUT, * )'---------------------------------------------------------'
   WRITE ( NOUT, * )
   WRITE ( NOUT, * )'Details of LA_ZGESDD LAPACK Subroutine Results.'
   WRITE ( NOUT, * )
!
   WRITE(NOUT,*)
...
! ERROR 6
   ...
   WRITE(NOUT,*) 'INFO = ', INFO
!
END PROGRAM LA_ZGESDD_ET_EXAMPLE
