...
!  .. EXECUTABLE STATEMENTS ..
  WRITE (NOUT,*) 'CHPGVX ET_Example Program Results.'
...
!
   WRITE ( NOUT, * )'---------------------------------------------------------'
   WRITE ( NOUT, * )
   WRITE ( NOUT, * )'Details of LA_CHPGVX LAPACK Subroutine Results.'
   WRITE ( NOUT, * )
!
   UPLO = 'U'
   WRITE(NOUT,*)
...
! ERROR 12
      ...
      WRITE(NOUT,*) 'INFO = ', INFO 
END PROGRAM LA_CHPGVX_ET_EXAMPLE
