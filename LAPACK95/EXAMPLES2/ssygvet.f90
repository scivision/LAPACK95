...
!  .. EXECUTABLE STATEMENTS ..
   WRITE(NOUT,*) 'SSYGV ET_Example Program Results.'
...
!
   WRITE(NOUT,*) '---------------------------------------------------------'
   WRITE(NOUT,*)
   WRITE ( NOUT, * )'Details of LA_SSYGV LAPACK Subroutine Results.'
   WRITE(NOUT,*)
!
   WRITE(NOUT,*)
...
!
   ...
   WRITE(NOUT,*) 'INFO = ',INFO
!
END PROGRAM LA_SSYGV_ET_EXAMPLE
