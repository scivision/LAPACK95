SUBROUTINE LA_TEST_ZGTSV(N, NRHS, DL, D, DU, B, LDB, INFO)
!
...
!  .. Array Arguments ..
   COMPLEX(WP), INTENT(INOUT) :: B(1:LDB,1:NRHS)
   COMPLEX(WP), INTENT(INOUT) :: DL(1:N-1), D(1:N), DU(1:N-1)
!  .. Parameters ..
   CHARACTER(LEN=8),  PARAMETER :: SRNAME = 'LA_GTSV '
   CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_ZGTSV '
!  .. Common blocks ..
   INTEGER :: INFOTC
