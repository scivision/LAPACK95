...
*  input.  The remaining lines specify the LAPACK90 test paths and the
...
*  following 38 lines:
*  Data file for testing COMPLEX*16 LAPACK90 linear equation routines
...
*  T                      Put T to test the LAPACK90 routines
...
*     .. Local Scalars ..
     ...
     $                   NNB, NNB2, NNS, NRHS, NNRHS, NTYPES
...
*
*     Read the flag that indicates whether to test the LAPACK90 routines.
*
      READ( NIN, FMT = * )TSTCHK
*
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF 
            CALL ZDRVGE( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF 
             CALL ZDRVGB( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR,
     $                   A( 1, 1 ), LA, A( 1, 3 ), LAFAC, A( 1, 6 ),
     $                   B( 1, 1 ), B( 1, 2 ), B( 1, 3 ), B( 1, 4 ), S,
     $                   WORK, RWORK, IWORK, NOUT, I )
      END DO
         ELSE
            WRITE( NOUT, FMT = 9988 )PATH
         END IF
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF 
             CALL ZDRVGT( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR,
     $                   A( 1, 1 ), A( 1, 2 ), B( 1, 1 ), B( 1, 2 ),
     $                   B( 1, 3 ), WORK, RWORK, IWORK, NOUT, I )
      END DO
         ELSE
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF 
             CALL ZDRVPO( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
     $                   B( 1, 2 ), B( 1, 3 ), B( 1, 4 ), S, WORK,
     $                   RWORK, NOUT, I )
      END DO
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF 
             CALL ZDRVPP( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
     $                   B( 1, 2 ), B( 1, 3 ), B( 1, 4 ), S, WORK,
     $                   RWORK, NOUT, I )
      END DO
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF 
           CALL ZDRVPB( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
     $                   B( 1, 2 ), B( 1, 3 ), B( 1, 4 ), S, WORK,
     $                   RWORK, NOUT, I )
      END DO
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF 
             CALL ZDRVPT( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR,
     $                   A( 1, 1 ), S, A( 1, 2 ), B( 1, 1 ), B( 1, 2 ),
     $                   B( 1, 3 ), WORK, RWORK, NOUT, I )
      END DO
         ELSE
            WRITE( NOUT, FMT = 9988 )PATH
         END IF
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF 
             CALL ZDRVHE( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF 
             CALL ZDRVHP( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
     $                   B( 1, 2 ), B( 1, 3 ), WORK, RWORK, IWORK,
     $                   NOUT, I )
      END DO
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF 
             CALL ZDRVSY( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
     $                   B( 1, 2 ), B( 1, 3 ), WORK, RWORK, IWORK,
     $                   NOUT, I )
      END DO
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF 
             CALL ZDRVSP( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
     $                   B( 1, 2 ), B( 1, 3 ), WORK, RWORK, IWORK,
     $                   NOUT, I )
      END DO
...
*
 ...
 9994 FORMAT( ' Tests of the COMPLEX*16 LAPACK routines ',
     $      / ' LAPACK VERSION 3.0, released April 30, 1999 ',
