...
*     .. External Subroutines ..
      EXTERNAL           LA_TEST_SGEEV, SGET22, SLABAD, SLACPY, SLASUM,
     &                   SLATME,
...
*
               ...
               IINFO = 0
               CALL LA_TEST_SGEEV( 'V', 'V', N, H, LDA, WR, WI, VL,
     &           LDVL, VR, LDVR, WORK, NNWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
                  RESULT( 1 ) = ULPINV
...
*
               CALL SLACPY( 'F', N, N, A, LDA, H, LDA )
              IINFO = 0
               CALL LA_TEST_SGEEV( 'N', 'N', N, H, LDA, WR1, WI1,
     &           DUM, 1, DUM, 1, WORK, NNWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
                  RESULT( 1 ) = ULPINV
...
*
               CALL SLACPY( 'F', N, N, A, LDA, H, LDA )
               IINFO = 0
               CALL LA_TEST_SGEEV( 'N', 'V', N, H, LDA, WR1, WI1,
     &           DUM, 1, LRE, LDLRE, WORK, NNWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
                  RESULT( 1 ) = ULPINV
...
*
               CALL SLACPY( 'F', N, N, A, LDA, H, LDA )
               IINFO = 0
               CALL LA_TEST_SGEEV( 'V', 'N', N, H, LDA, WR1, WI1,
     &           LRE, LDLRE, DUM, 1, WORK, NNWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
                  RESULT( 1 ) = ULPINV
