SUBROUTINE LA_TEST_ZHESVX( FACT, UPLO, N, NRHS, A, LDA, AF, LDAF, IPIV, &
...
!  .. Parameters ..
      ...
      CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_ZHESVX'
!  .. Common blocks ..
      INTEGER :: INFOTC
...
!  .. Executable Statements ..
      ...
      CASE(0)
      IF ( NRHS == 1 )  THEN
        CALL LA_HESVX( A(1:IA1,1:IA2), B(1:IB1,1), X(1: IX1, 1), &
     &    UPLO, AF(1: IAF1, 1:IAF2), IPIV(1:IIPIV), IFACT, &
     &    FERR(1), BERR(1), RCOND,  INFO )
        INFO = INFOTC 
      ELSE
        CALL LA_HESVX( A(1:IA1,1:IA2), B(1:IB1,1:IB2), X(1:IX1, 1:IX2), &
     &    UPLO, AF(1 : IAF1, 1:IAF2), IPIV(1:IIPIV), IFACT,&
