...
*     .. External Subroutines ..
     ...
     $                   LA_TEST_DPOSV,  LA_TEST_DPOSVX, DPOT01, DPOT02,
     $                   DPOT05, DPOTRF, DPOTRI, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
                        SRNAMT = 'DPOSV '
                        INFO = INFO90
                        CALL LA_TEST_DPOSV( UPLO, N, NRHS, AFAC, LDA,
     $                             X, LDA, INFO )
*
...
*
                     SRNAMT = 'DPOSVX'
                     INFO = 0
                     CALL LA_TEST_DPOSVX( FACT, UPLO, N, NRHS, A, LDA,
     &                 AFAC, LDA, EQUED, S, B, LDA, X, LDA,
