...
*     .. External Subroutines ..
     ...
     $                   ZLATSP, ZPPT05, LA_TEST_ZSPSV, LA_TEST_ZSPSVX,
     $                   ZSPT01, ZSPT02, ZSPTRF, ZSPTRI
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
      CHARACTER*6        SRNAMT
...
*
                     SRNAMT = 'ZSPSV '
                     INFO = INFO90
                     CALL LA_TEST_ZSPSV( UPLO, N, NRHS, AFAC, IWORK, X,
     $                                     LDA, INFO )
...
*
      SRNAMT = 'ZSPSVX'
      INFO = INFO90
      CALL LA_TEST_ZSPSVX( FACT, UPLO, N, NRHS, A, AFAC, IWORK, B,
