SUBROUTINE LA_TEST_ZGGLSE( M, N, P, A, LDA, B, LDB, C, D, X, WORK, LWORK, INFO )
!
...
!  .. Array Arguments ..
   ...
   COMPLEX(WP), INTENT(INOUT) :: C(1: M), D(1: P)
   COMPLEX(WP), INTENT(OUT) :: WORK(1: LWORK), X(1: N)
!  .. Parameters ..
   CHARACTER(LEN=8),  PARAMETER :: SRNAME = 'LA_GGLSE'
   CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_ZGGLSE'
!  .. Common blocks ..
   INTEGER :: INFOTC
