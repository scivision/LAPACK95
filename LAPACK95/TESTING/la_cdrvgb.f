...
*     .. Scalar Arguments ..
      LOGICAL            TSTERR
      INTEGER            LA, LAFB, NN, NOUT, NRHS, INFO90
      REAL               THRESH
*     ..
*     .. Array Arguments ..
      LOGICAL            DOTYPE( * )
...
*     .. External Subroutines ..
      EXTERNAL           ALADHD, ALAERH, ALASVM, CERRVX, CGBEQU,
     $                   LA_TEST_CGBSV,  LA_TEST_CGBSVX, CGBT01, CGBT02,
     &                   CGBT05,
     $                   CGBTRF, CGBTRS, CGET04, CLACPY, CLAQGB, CLARHS,
     $                   CLASET, CLATB4, CLATMS, XLAENV
*     ..
*     .. Intrinsic Functions ..
...
*
                              SRNAMT = 'CGBSV '
                              INFO = INFO90
                              CALL LA_TEST_CGBSV( N, KL, KU, NRHS, AFB,
     $                                    LDAFB, IWORK, X, LDB, INFO )
*
...
*
                           SRNAMT = 'CGBSVX'
                           INFO = 0
                           CALL LA_TEST_CGBSVX( FACT, TRANS, N, KL, KU,
     &                                  NRHS, A,
