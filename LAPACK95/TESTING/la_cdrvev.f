...
*     .. External Subroutines ..
      EXTERNAL           LA_TEST_CGEEV, CGET22, CLACPY, CLATME, CLATMR,
     &                   CLATMS, CLASET, SLABAD, SLASUM, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
               ...
               IINFO = 0
               CALL LA_TEST_CGEEV( 'V', 'V', N, H, LDA, W, VL, LDVL,
     &           VR, LDVR, WORK, NNWORK, RWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
                  RESULT( 1 ) = ULPINV
...
*
               CALL CLACPY( 'F', N, N, A, LDA, H, LDA )
               IINFO = 0
               CALL LA_TEST_CGEEV( 'N', 'N', N, H, LDA, W1, DUM, 1,
     &           DUM, 1,  WORK, NNWORK, RWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
                  RESULT( 1 ) = ULPINV
...
*
               CALL CLACPY( 'F', N, N, A, LDA, H, LDA )
               IINFO = 0
               CALL LA_TEST_CGEEV( 'N', 'V', N, H, LDA, W1, DUM, 1,
     &           LRE, LDLRE, WORK, NNWORK, RWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
                  RESULT( 1 ) = ULPINV
...
*
               CALL CLACPY( 'F', N, N, A, LDA, H, LDA )
               IINFO = 0
               CALL LA_TEST_CGEEV( 'V', 'N', N, H, LDA, W1, LRE,
     &          LDLRE, DUM, 1, WORK, NNWORK, RWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
                  RESULT( 1 ) = ULPINV
