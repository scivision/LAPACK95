...
*     .. External Subroutines ..
     ...
     $                   ZGET04, LA_TEST_ZHPSV, LA_TEST_ZHPSVX, ZHPT01,
     &                   ZHPTRF,
     $                   ZHPTRI, ZLACPY, ZLAIPD, ZLARHS, ZLASET, ZLATB4,
     $                   ZLATMS, ZPPT02, ZPPT05
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
      CHARACTER*6        SRNAMT
...
*
                     SRNAMT = 'ZHPSV '
                     INFO = INFO90
                     CALL LA_TEST_ZHPSV( UPLO, N, NRHS, AFAC, IWORK,
     $                                    X, LDA, INFO )
*
...
*
      SRNAMT = 'ZHPSVX'
      INFO = INFO90
      CALL LA_TEST_ZHPSVX( FACT, UPLO, N, NRHS, A, AFAC, IWORK, B,
