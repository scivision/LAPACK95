...
*     .. External Subroutines ..
      EXTERNAL           LA_TEST_SGEES, SHST01, SLABAD, SLACPY, SLASUM,
     &                   SLATME, SLATMR, SLATMS, SLASET, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
                  ...
                  IINFO = 0
                  CALL LA_TEST_SGEES( 'V', SORT, SSLECT, N, H, LDA,
     &              SDIM, WR,
...
*
                  ...
                  IINFO = 0
                  CALL LA_TEST_SGEES( 'N', SORT, SSLECT, N, HT, LDA,
     &              SDIM, WRT,
