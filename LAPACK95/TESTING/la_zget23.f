...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, LA_TEST_ZGEEVX, ZGET22, ZLACPY
*     ..
*     .. Intrinsic Functions ..
...
*
      ...
      IINFO = 0
      CALL LA_TEST_ZGEEVX( BALANC, 'V', 'V', SENSE, N, H, LDA, W, VL,
     &             LDVL, VR,
...
*
         CALL ZLACPY( 'F', N, N, A, LDA, H, LDA )
         IINFO = 0
         CALL LA_TEST_ZGEEVX( BALANC, 'N', 'N', SENSE, N, H, LDA, W1,
     &     CDUM, 1,
...
*
         CALL ZLACPY( 'F', N, N, A, LDA, H, LDA )
         IINFO = 0
         CALL LA_TEST_ZGEEVX( BALANC, 'N', 'V', SENSE, N, H, LDA, W1,
     &     CDUM, 1,
...
*
         CALL ZLACPY( 'F', N, N, A, LDA, H, LDA )
         IINFO = 0
         CALL LA_TEST_ZGEEVX( BALANC, 'V', 'N', SENSE, N, H, LDA,
     &     W1, LRE,
...
*
      IF( COMP ) THEN
        CALL ZLACPY( 'F', N, N, A, LDA, H, LDA )
        IINFO = 0
         CALL LA_TEST_ZGEEVX( 'N', 'V', 'V', 'B', N, H, LDA, W, VL,
     &     LDVL, VR,
