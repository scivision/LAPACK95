SUBROUTINE LA_TEST_SPOSVX( FACT, UPLO, N, NRHS, A, LDA, AF, LDAF, EQUED, &
...
!  .. Array Arguments ..
      ...
      REAL(WP), INTENT(INOUT) :: A(1:LDA,1:N), B(1:LDB,1:NRHS), AF(1:LDAF,1:N)
...
!  .. Parameters ..
      ...
      CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_SPOSVX'
!  .. Common blocks ..
      INTEGER :: INFOTC
