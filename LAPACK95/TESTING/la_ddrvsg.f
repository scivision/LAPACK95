...
*     .. External Subroutines ..
     ...
     $                   DLATMS, LA_TEST_DSBGV, LA_TEST_DSBGVD,
     &                   LA_TEST_DSBGVX, DSGT01, LA_TEST_DSPGV,
     $                   LA_TEST_DSPGVD, LA_TEST_DSPGVX, LA_TEST_DSYGV,
     &                   LA_TEST_DSYGVD, LA_TEST_DSYGVX,
     &                   XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
                IINFO = 0
                  CALL LA_TEST_DSYGV( IBTYPE, 'V', UPLO, N, Z, LDZ, BB,
     &              LDB, D, WORK, NWORK, IINFO )
                  IF( IINFO.NE.0 ) THEN
...
*
                  IINFO = 0
                  CALL LA_TEST_DSYGVD( IBTYPE, 'V', UPLO, N, Z, LDZ, BB,
     &              LDB, D, WORK, NWORK, IWORK, LIWORK, IINFO )
                  IF( IINFO.NE.0 ) THEN
...
*
                  IINFO = 0
                  CALL LA_TEST_DSYGVX( IBTYPE, 'V', 'A', UPLO, N, AB,
     &              LDA, BB,
...
*
                  ...
                  VU = ANORM
                  IINFO = 0
                  CALL LA_TEST_DSYGVX( IBTYPE, 'V', 'V', UPLO, N, AB,
     &              LDA, BB,
     $                         LDB, VL, VU, IL, IU, ABSTOL, M, D, Z,
     $                         LDZ, WORK, NWORK, IWORK( N+1 ), IWORK,
     $                         IINFO )
...
*
                  IINFO = 0
                  CALL LA_TEST_DSYGVX( IBTYPE, 'V', 'I', UPLO, N, AB,
     &              LDA, BB,
     $                         LDB, VL, VU, IL, IU, ABSTOL, M, D, Z,
     $                         LDZ, WORK, NWORK, IWORK( N+1 ), IWORK,
     $                         IINFO )
...
*
                  IINFO = 0
                  CALL LA_TEST_DSPGV( IBTYPE, 'V', UPLO, N, AP, BP, D,
     &              Z, LDZ,
     $                        WORK, IINFO )
                  IF( IINFO.NE.0 ) THEN
...
*
                  IINFO = 0
                  CALL LA_TEST_DSPGVD( IBTYPE, 'V', UPLO, N, AP, BP, D,
     &              Z, LDZ, WORK, NWORK, IWORK, LIWORK, IINFO )
                  IF( IINFO.NE.0 ) THEN
...
*
                  IINFO = 0
                  CALL LA_TEST_DSPGVX( IBTYPE, 'V', 'A', UPLO, N, AP,
     &              BP, VL,
...
*
                  ...
                  VU = ANORM
                  IINFO = 0
                  CALL LA_TEST_DSPGVX( IBTYPE, 'V', 'V', UPLO, N,
     &              AP, BP, VL,
     $                         VU, IL, IU, ABSTOL, M, D, Z, LDZ, WORK,
     $                         IWORK( N+1 ), IWORK, IINFO )
                  IF( IINFO.NE.0 ) THEN
...
*
                  IINFO = 0
                  CALL LA_TEST_DSPGVX( IBTYPE, 'V', 'I', UPLO, N, AP,
     &              BP, VL,
     $                         VU, IL, IU, ABSTOL, M, D, Z, LDZ, WORK,
     $                         IWORK( N+1 ), IWORK, IINFO )
                  IF( IINFO.NE.0 ) THEN
...
*
                     IINFO = 0
                     CALL LA_TEST_DSBGV( 'V', UPLO, N, KA, KB, AB,
     &                         LDA, BB, LDB,
     $                           D, Z, LDZ, WORK, IINFO )
                     IF( IINFO.NE.0 ) THEN
...
*
                     IINFO = 0
                     CALL LA_TEST_DSBGVD ( 'V', UPLO, N, KA, KB, AB,
     &                 LDA, BB,  LDB, D, Z, LDZ, WORK, NWORK, IWORK,
     $                            LIWORK, IINFO )
                     IF( IINFO.NE.0 ) THEN
...
*
                     IINFO = 0
                     CALL LA_TEST_DSBGVX( 'V', 'A', UPLO, N, KA, KB,
     &                 AB, LDA,
...
*
                     ...
                     VU = ANORM
                     IINFO = 0
                     CALL LA_TEST_DSBGVX( 'V', 'V', UPLO, N, KA, KB,
     &                 AB, LDA,
     $                            BB, LDB, BP, MAX( 1, N ), VL, VU, IL,
     $                            IU, ABSTOL, M, D, Z, LDZ, WORK,
     $                            IWORK( N+1 ), IWORK, IINFO )
...
*
                     IINFO = 0
                     CALL LA_TEST_DSBGVX( 'V', 'I', UPLO, N, KA, KB,
     &                 AB, LDA,
     $                            BB, LDB, BP, MAX( 1, N ), VL, VU, IL,
     $                            IU, ABSTOL, M, D, Z, LDZ, WORK,
     $                            IWORK( N+1 ), IWORK, IINFO )
