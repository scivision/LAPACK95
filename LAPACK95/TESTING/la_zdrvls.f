...
*     .. External Subroutines ..
     ...
     $                   ZDSCAL, ZERRLS, LA_TEST_ZGELS, ZGELSD,
     $                   LA_TEST_ZGELSS,
     $                   LA_TEST_ZGELSX,
...
*
     ...
     $                                        COPYB, LDB, B, LDB )
                              ...
                              SRNAMT = 'ZGELS '
                              INFO = INFO90
                              CALL LA_TEST_ZGELS( TRANS, M, N, NRHS, A,
...
*
                     SRNAMT = 'ZGELSX'
                     INFO = 0
                     CALL LA_TEST_ZGELSX( M, N, NRHS, A, LDA, B, LDB,
...
*
                        SRNAMT = 'ZGELSY'
                        INFO = INFO90
                        CALL LA_TEST_ZGELSY( M, N, NRHS, A, LDA, B,
     $                    LDB, IWORK, RCOND, CRANK, WORK, LWLSY, RWORK,
     $                    INFO )
                        IF( INFO.NE.0 )
...
*
     ...
     $                               LDB )
                        SRNAMT = 'ZGELSS'
                        INFO = INFO90
                        CALL LA_TEST_ZGELSS( M, N, NRHS, A, LDA, B, LDB,
     &                               S,
...
*
                        SRNAMT = 'ZGELSD'
                        INFO = 0
                        CALL LA_TEST_ZGELSD( M, N, NRHS, A, LDA, B, LDB,
     &                               S,
     $                               RCOND, CRANK, WORK, LWORK, RWORK,
     $                               IWORK, INFO )
                        IF( INFO.NE.0 )
