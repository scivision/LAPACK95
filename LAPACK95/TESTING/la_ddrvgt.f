     ...
     $                   B, X, XACT, WORK, RWORK, IWORK, NOUT, INFO90)
*
...
*     .. External Subroutines ..
     ...
     $                   LA_TEST_DGTSV, LA_TEST_DGTSVX, DGTT01, DGTT02,
     $                   DGTT05, DGTTRF, DGTTRS, DLACPY, DLAGTM, DLARNV,
     $                   DLASET, DLATB4, DLATMS, DSCAL
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
                     SRNAMT = 'DGTSV '
                     INFO = INFO90
                     CALL LA_TEST_DGTSV( N, NRHS, AF, AF( M+1 ),
     $                 AF( N+M+1 ), X, LDA, INFO )
*
...
*
                  SRNAMT = 'DGTSVX'
                  INFO = INFO90
                  CALL LA_TEST_DGTSVX( FACT, TRANS, N, NRHS, A,
     &              A( M+1 ),
