SUBROUTINE LA_TEST_ZGELSY( M, N, NRHS, A, LDA, B, LDB, JPVT, RCOND, RANK, WORK, LWORK, RWORK, INFO )
!
...
!  .. Parameters ..
      ...
      CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_ZGELSY'
!  .. Common blocks ..
      INTEGER :: INFOTC
