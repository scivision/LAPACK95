...
*     .. External Subroutines ..
     ...
     $                   LA_TEST_CPTSV, LA_TEST_CPTSVX, CPTT01, CPTT02,
     &                   CPTT05,
     $                   CPTTRF, CPTTRS, CSSCAL, SCOPY, SLARNV, SSCAL
*     ..
*     .. Intrinsic Functions ..
...
*
                  SRNAMT = 'CPTSV '
                  INFO = INFO90
                  CALL LA_TEST_CPTSV( N, NRHS, D( N+1 ), E( N+1 ), X,
     $                                 LDA, INFO )
*
...
*
               SRNAMT = 'CPTSVX'
               INFO = INFO90
               CALL LA_TEST_CPTSVX( FACT, N, NRHS, D, E, D( N+1 ),
     &                      E( N+1 ), B,
