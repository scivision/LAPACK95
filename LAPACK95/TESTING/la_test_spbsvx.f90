SUBROUTINE LA_TEST_SPBSVX(FACT, UPLO, N, KD, NRHS, AB, LDAB, AFB, &
...
!  .. Array Arguments ..
     ...
     &  AFB(1:LDAFB, 1:N),  S(1:N)
      REAL(WP), INTENT(OUT) :: X(1:LDX,1:NRHS), WORK(1:3*N), FERR(1:NRHS), &
     &  BERR(1:NRHS)
      INTEGER, INTENT(OUT) :: IWORK(1:N) 
!  .. Parameters ..
   CHARACTER(LEN=8),  PARAMETER :: SRNAME = 'LA_PBSVX'
   CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_SPBSVX'
!  .. Common blocks ..
   INTEGER :: INFOTC
