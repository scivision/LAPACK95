...
*  =======
*
*  SCHKAA is the main test program for the REAL LAPACK90
...
*  following 36 lines:
*  Data file for testing REAL LAPACK90 linear eqn. routines
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF
            CALL SDRVGE( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF 
           CALL SDRVGB( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR,
         ...
         IF( TSTDRV ) THEN
           DO I = 1            , 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF 
             CALL SDRVGT( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR,
     $                   A( 1, 1 ), A( 1, 2 ), B( 1, 1 ), B( 1, 2 ),
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF 
           CALL SDRVPO( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
     $                   B( 1, 2 ), B( 1, 3 ), B( 1, 4 ), S, WORK,
     $                   RWORK, IWORK, NOUT, I )
      END DO 
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF   
            CALL SDRVPP( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
     $                   B( 1, 2 ), B( 1, 3 ), B( 1, 4 ), S, WORK,
     $                   RWORK, IWORK, NOUT, I )
      END DO
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF   
            CALL SDRVPB( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
     $                   B( 1, 2 ), B( 1, 3 ), B( 1, 4 ), S, WORK,
     $                   RWORK, IWORK, NOUT, I )
      END DO
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF   
             CALL SDRVPT( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
     $                   B( 1, 2 ), B( 1, 3 ), WORK, RWORK, NOUT, I )
      END DO
         ELSE
            WRITE( NOUT, FMT = 9988 )PATH
         END IF
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF   
             CALL SDRVSY( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF   
             CALL SDRVSP( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
     $                   B( 1, 2 ), B( 1, 3 ), WORK, RWORK, IWORK,
     $                   NOUT, I )
      END DO
...
*
     ...
     $                   RWORK, RWORK( NMAX+1 ), WORK, IWORK, NOUT, I )
      END DO
      ELSE
        WRITE( NOUT, FMT = 9988 )PATH
      END IF
