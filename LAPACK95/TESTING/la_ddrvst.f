...
*     .. External Subroutines ..
     ...
     $                   DLATMS, LA_TEST_DSBEV, LA_TEST_DSBEVD,
     &                   LA_TEST_DSBEVX, LA_TEST_DSPEV, LA_TEST_DSPEVD,
     $                   LA_TEST_DSPEVX, LA_TEST_DSTEV, LA_TEST_DSTEVD,
     &                   LA_TEST_DSTEVR,
     &                   LA_TEST_DSTEVX, DSTT21,
     $                   DSTT22, LA_TEST_DSYEV, LA_TEST_DSYEVD,
     &                   LA_TEST_DSYEVR, LA_TEST_DSYEVX, DSYT21,
     $                   DSYT22, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
  ...
  130           CONTINUE
               IINFO = 0
               CALL LA_TEST_DSTEV( 'V', N, D1, D2, Z, LDU, WORK,
     &           IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
  ...
  160           CONTINUE
               IINFO = 0
               CALL LA_TEST_DSTEV( 'N', N, D3, D4, Z, LDU, WORK,
     &           IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
  ...
  200           CONTINUE
                IINFO = 0
               CALL LA_TEST_DSTEVX( 'V', 'A', N, D1, D2, VL, VU, IL,
     &                      IU, ABSTOL,
...
*
  ...
  230           CONTINUE
                IINFO = 0
               CALL LA_TEST_DSTEVX( 'N', 'A', N, D3, D4, VL, VU, IL,
     &                      IU, ABSTOL,
...
*
  ...
  270           CONTINUE
                IINFO = 0
               CALL LA_TEST_DSTEVR( 'V', 'A', N, D1, D2, VL, VU, IL,
     &           IU, ABSTOL,
...
*
  ...
  300           CONTINUE
                IINFO = 0
               CALL LA_TEST_DSTEVR( 'N', 'A', N, D3, D4, VL, VU, IL,
     &           IU, ABSTOL,
...
*
  ...
  340           CONTINUE
                IINFO = 0
               CALL LA_TEST_DSTEVX( 'V', 'I', N, D1, D2, VL, VU, IL,
     &                      IU, ABSTOL,
     $                      M2, WA2, Z, LDU, WORK, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
  ...
  370           CONTINUE
                IINFO = 0
               CALL LA_TEST_DSTEVX( 'N', 'I', N, D3, D4, VL, VU, IL,
     &                      IU, ABSTOL,
...
*
               IINFO = 0
               CALL LA_TEST_DSTEVX( 'V', 'V', N, D1, D2, VL, VU, IL,
     &                      IU, ABSTOL,
     $                      M2, WA2, Z, LDU, WORK, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
  ...
  430           CONTINUE
                IINFO = 0
               CALL LA_TEST_DSTEVX( 'N', 'V', N, D3, D4, VL, VU, IL,
     &                      IU, ABSTOL,
     $                      M3, WA3, Z, LDU, WORK, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
  ...
  460           CONTINUE
                IINFO = 0
               CALL LA_TEST_DSTEVD( 'V', N, D1, D2, Z, LDU, WORK,
     &           LWEDC, IWORK,
     $                      LIWEDC, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
  ...
  490           CONTINUE
                IINFO = 0
               CALL LA_TEST_DSTEVD( 'N', N, D3, D4, Z, LDU, WORK,
     &           LWEDC, IWORK,
     $                      LIWEDC, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
  ...
  530           CONTINUE
                IINFO = 0
               CALL LA_TEST_DSTEVR( 'V', 'I', N, D1, D2, VL, VU, IL,
     &           IU, ABSTOL,
     $                      M2, WA2, Z, LDU, IWORK, WORK, LWORK,
     $                      IWORK(2*N+1), LIWORK-2*N, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
  ...
  560           CONTINUE
                IINFO = 0
               CALL LA_TEST_DSTEVR( 'N', 'I', N, D3, D4, VL, VU, IL,
     &           IU, ABSTOL,
...
*
               IINFO = 0
               CALL LA_TEST_DSTEVR( 'V', 'V', N, D1, D2, VL, VU, IL,
     &           IU, ABSTOL,
     $                      M2, WA2, Z, LDU, IWORK, WORK, LWORK,
     $                      IWORK(2*N+1), LIWORK-2*N, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
  ...
  620          CONTINUE
               IINFO = 0
               CALL LA_TEST_DSTEVR( 'N', 'V', N, D3, D4, VL, VU, IL,
     &           IU, ABSTOL,
     $                      M3, WA3, Z, LDU, IWORK, WORK, LWORK,
     $                      IWORK(2*N+1), LIWORK-2*N, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_DSYEV( 'V', UPLO, N, A, LDU, D1, WORK,
     $           LWORK,  IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 2
               IINFO = 0
               CALL LA_TEST_DSYEV( 'N', UPLO, N, A, LDU, D3, WORK,
     $           LWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               IINFO = 0
               CALL LA_TEST_DSYEVX( 'V', 'A', UPLO, N, A, LDU, VL,
     &                      VU, IL, IU,
...
*
      NTEST = NTEST + 2
      IINFO = 0
               CALL LA_TEST_DSYEVX( 'N', 'A', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
...
*
               ...
               CALL DLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0
               CALL LA_TEST_DSYEVX( 'V', 'I', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M2, WA2, Z, LDU, WORK, LWORK, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               ...
               CALL DLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0
               CALL LA_TEST_DSYEVX( 'N', 'I', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
...
*
               ...
               CALL DLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0
               CALL LA_TEST_DSYEVX( 'V', 'V', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M2, WA2, Z, LDU, WORK, LWORK, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               ...
               CALL DLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0
               CALL LA_TEST_DSYEVX( 'N', 'V', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M3, WA3, Z, LDU, WORK, LWORK, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_DSPEV( 'V', UPLO, N, WORK, D1, Z, LDU,
     &           V, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 2
               IINFO = 0
               CALL LA_TEST_DSPEV( 'N', UPLO, N, WORK, D3, Z, LDU,
     &           V, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               IINFO = 0
               CALL LA_TEST_DSPEVX( 'V', 'A', UPLO, N, WORK, VL, VU,
     &                      IL, IU,
...
*
               IINFO = 0
               CALL LA_TEST_DSPEVX( 'N', 'A', UPLO, N, WORK, VL, VU,
     &                      IL, IU,
...
*
               IINFO = 0
               CALL LA_TEST_DSPEVX( 'V', 'I', UPLO, N, WORK, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M2, WA2, Z, LDU, V, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               IINFO = 0
               CALL LA_TEST_DSPEVX( 'N', 'I', UPLO, N, WORK, VL, VU,
     &                      IL, IU,
...
*
               IINFO = 0
               CALL LA_TEST_DSPEVX( 'V', 'V', UPLO, N, WORK, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M2, WA2, Z, LDU, V, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               IINFO = 0
               CALL LA_TEST_DSPEVX( 'N', 'V', UPLO, N, WORK, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M3, WA3, Z, LDU, V, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_DSBEV( 'V', UPLO, N, KD, V, LDU, D1, Z,
     &           LDU, WORK, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 2
               IINFO = 0
               CALL LA_TEST_DSBEV( 'N', UPLO, N, KD, V, LDU, D3, Z,
     $           LDU, WORK, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_DSBEVX( 'V', 'A', UPLO, N, KD, V, LDU, U,
     &                      LDU, VL,
...
*
               IINFO = 0
               CALL LA_TEST_DSBEVX( 'N', 'A', UPLO, N, KD, V, LDU, U,
     &           LDU, VL,
...
*
               IINFO = 0
               CALL LA_TEST_DSBEVX( 'V', 'I', UPLO, N, KD, V, LDU, U,
     &           LDU, VL,
...
*
               IINFO = 0
               CALL LA_TEST_DSBEVX( 'N', 'I', UPLO, N, KD, V, LDU, U,
     &           LDU, VL,
     $                      VU, IL, IU, ABSTOL, M3, WA3, Z, LDU, WORK,
     $                      IWORK, IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               IINFO =  0
               CALL LA_TEST_DSBEVX( 'V', 'V', UPLO, N, KD, V, LDU, U,
     &           LDU, VL,
     $                      VU, IL, IU, ABSTOL, M2, WA2, Z, LDU, WORK,
     $                      IWORK, IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               IINFO = 0
               CALL LA_TEST_DSBEVX( 'N', 'V', UPLO, N, KD, V, LDU, U,
     &           LDU, VL,
     $                      VU, IL, IU, ABSTOL, M3, WA3, Z, LDU, WORK,
     $                      IWORK, IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_DSYEVD( 'V', UPLO, N, A, LDU, D1, WORK,
...
*
               NTEST = NTEST + 2
               IINFO = 0
               CALL LA_TEST_DSYEVD( 'N', UPLO, N, A, LDU, D3, WORK,
     &           LWEDC, IWORK, LIWEDC, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_DSPEVD( 'V', UPLO, N, WORK, D1, Z, LDU,
...
*
               NTEST = NTEST + 2
               IINFO = 0
               CALL LA_TEST_DSPEVD( 'N', UPLO, N, WORK, D3, Z, LDU,
     $                      WORK( INDX ), LWEDC-INDX+1, IWORK, LIWEDC,
     $                      IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_DSBEVD( 'V', UPLO, N, KD, V, LDU, D1, Z,
     $           LDU, WORK, LWEDC, IWORK, LIWEDC, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 2
               IINFO = 0
               CALL LA_TEST_DSBEVD( 'N', UPLO, N, KD, V, LDU, D3, Z,
     $           LDU, WORK,  LWEDC, IWORK, LIWEDC, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               ...
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_DSYEVR( 'V', 'A', UPLO, N, A, LDU, VL, VU,
     &           IL, IU,
...
*
      NTEST = NTEST + 2
      IINFO = 0
               CALL LA_TEST_DSYEVR( 'N', 'A', UPLO, N, A, LDU, VL, VU,
     &           IL, IU,
...
*
               ...
               CALL DLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0
               CALL LA_TEST_DSYEVR( 'V', 'I', UPLO, N, A, LDU, VL, VU,
     &           IL, IU,
     $                      ABSTOL, M2, WA2, Z, LDU, IWORK, WORK, LWORK,
     $                      IWORK(2*N+1), LIWORK-2*N, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               ...
               CALL DLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0
               CALL LA_TEST_DSYEVR( 'N', 'I', UPLO, N, A, LDU, VL, VU,
     &           IL, IU,
...
*
               ...
               CALL DLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0
               CALL LA_TEST_DSYEVR( 'V', 'V', UPLO, N, A, LDU, VL, VU,
     &           IL, IU,
     $                      ABSTOL, M2, WA2, Z, LDU, IWORK, WORK, LWORK,
     $                      IWORK(2*N+1), LIWORK-2*N, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               ...
               CALL DLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0
               CALL LA_TEST_DSYEVR( 'N', 'V', UPLO, N, A, LDU, VL, VU,
     &           IL, IU,
     $                      ABSTOL, M3, WA3, Z, LDU, IWORK, WORK, LWORK,
     $                      IWORK(2*N+1), LIWORK-2*N, IINFO )
               IF( IINFO.NE.0 ) THEN
