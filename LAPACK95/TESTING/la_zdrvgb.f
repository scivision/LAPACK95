...
*     .. External Subroutines ..
     ...
     $                   LA_TEST_ZGBSV,  LA_TEST_ZGBSVX, ZGBT01, ZGBT02,
     &                   ZGBT05,
     $                   ZGBTRF, ZGBTRS, ZGET04, ZLACPY, ZLAQGB, ZLARHS,
...
*
                              SRNAMT = 'ZGBSV '
                              INFO = INFO90
                              CALL LA_TEST_ZGBSV( N, KL, KU, NRHS, AFB,
...
*
                           SRNAMT = 'ZGBSVX'
                           INFO = 0
                           CALL LA_TEST_ZGBSVX( FACT, TRANS, N, KL, KU,
     &                                  NRHS, A,
