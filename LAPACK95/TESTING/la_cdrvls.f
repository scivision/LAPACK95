...
*     .. Scalar Arguments ..
      LOGICAL            TSTERR
      INTEGER            NM, NN, NNB, NNS, NOUT, INFO90
      REAL               THRESH
*     ..
*     .. Array Arguments ..
      LOGICAL            DOTYPE( * )
...
*     .. External Subroutines ..
      EXTERNAL           ALAERH, ALAHD, ALASVM, CERRLS, LA_TEST_CGELS,
     $                   LA_TEST_CGELSD,
     $                   LA_TEST_CGELSS, LA_TEST_CGELSX, LA_TEST_CGELSY,
     &                   CGEMM,
     &                   CLACPY, CLARNV,
...
*
     ...
     $                                        COPYB, LDB, B, LDB )
                              ...
                              SRNAMT = 'CGELS '
                              INFO = INFO90
                              CALL LA_TEST_CGELS( TRANS, M, N, NRHS, A,
...
*
                     SRNAMT = 'CGELSX'
                     INFO = INFO90
                     CALL LA_TEST_CGELSX( M, N, NRHS, A, LDA, B, LDB,
     $                    IWORK, RCOND, CRANK, WORK, RWORK, INFO )
*
                     IF( INFO.NE.0 )
...
*
                        SRNAMT = 'CGELSY'
                        INFO = INFO90
                        CALL LA_TEST_CGELSY( M, N, NRHS, A, LDA, B,
     &                               LDB, IWORK,
...
*
     ...
     $                               LDB )
                        SRNAMT = 'CGELSS'
                        INFO = INFO90
                        CALL LA_TEST_CGELSS( M, N, NRHS, A, LDA, B, LDB,
     $                    S, RCOND, CRANK, WORK, LWORK, RWORK, INFO )
*
                        IF( INFO.NE.0 )
...
*
                        SRNAMT = 'CGELSD'
                        INFO = INFO90
                        CALL LA_TEST_CGELSD( M, N, NRHS, A, LDA, B,
     &                               LDB, S,
