...
*     .. External Subroutines ..
      EXTERNAL           ALASVM, DLABAD, XERBLA, ZGET52, LA_TEST_ZGGEV,
...
*
            ...
            CALL ZLACPY( ' ', N, N, B, LDA, T, LDA )
              ...
              IERR = 0
            CALL LA_TEST_ZGGEV( 'V', 'V', N, S, LDA, T, LDA,
     &                  ALPHA, BETA, Q,
...
*
            ...
            CALL ZLACPY( ' ', N, N, B, LDA, T, LDA )
              IERR = 0
            CALL LA_TEST_ZGGEV( 'N', 'N', N, S, LDA, T, LDA,
     &                  ALPHA1, BETA1, Q,
     $                  LDQ, Z, LDQ, WORK, LWORK, RWORK, IERR )
            IF( IERR.NE.0 .AND. IERR.NE.N+1 ) THEN
               RESULT( 1 ) = ULPINV
...
*
            ...
            CALL ZLACPY( ' ', N, N, B, LDA, T, LDA )
            IERR = 0
            CALL LA_TEST_ZGGEV( 'V', 'N', N, S, LDA, T, LDA,
     &                  ALPHA1, BETA1, QE,
...
*
            ...
            CALL ZLACPY( ' ', N, N, B, LDA, T, LDA )
              IERR = 0
            CALL LA_TEST_ZGGEV( 'N', 'V', N, S, LDA, T, LDA, ALPHA1,
     &                  BETA1, Q,
