...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZCOPY, LA_TEST_ZGEESX, ZGEMM, ZLACPY,
     &  ZUNT01
*     ..
*     .. Intrinsic Functions ..
...
*
         ...
         IINFO = 0
         CALL LA_TEST_ZGEESX( 'V', SORT, ZSLECT, 'N', N, H, LDA, SDIM,
     &                W, VS,
...
*
         ...
         IINFO = 0
         CALL LA_TEST_ZGEESX( 'N', SORT, ZSLECT, 'N', N, HT, LDA, SDIM,
     &     WT, VS,
     $                LDVS, RCONDE, RCONDV, WORK, LWORK, RWORK, BWORK,
     $                IINFO )
         IF( IINFO.NE.0 ) THEN
...
*
         ...
         CALL ZLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0
         CALL LA_TEST_ZGEESX( 'V', SORT, ZSLECT, 'B', N, HT, LDA,
     &     SDIM1, WT,
...
*
         CALL ZLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0
         CALL LA_TEST_ZGEESX( 'N', SORT, ZSLECT, 'B', N, HT, LDA,SDIM1,
     &     WT,
...
*
         CALL ZLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0
         CALL LA_TEST_ZGEESX( 'V', SORT, ZSLECT, 'E', N, HT, LDA, SDIM1,
     &     WT,
     $                VS1, LDVS, RCNDE1, RCNDV1, WORK, LWORK, RWORK,
     $                BWORK, IINFO )
         IF( IINFO.NE.0 ) THEN
...
*
         CALL ZLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0
         CALL LA_TEST_ZGEESX( 'N', SORT, ZSLECT, 'E', N, HT, LDA, SDIM1,
     &     WT,
     $                VS1, LDVS, RCNDE1, RCNDV1, WORK, LWORK, RWORK,
     $                BWORK, IINFO )
         IF( IINFO.NE.0 ) THEN
...
*
         CALL ZLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0
         CALL LA_TEST_ZGEESX( 'V', SORT, ZSLECT, 'V', N, HT, LDA, SDIM1,
     &     WT,
     $                VS1, LDVS, RCNDE1, RCNDV1, WORK, LWORK, RWORK,
     $                BWORK, IINFO )
         IF( IINFO.NE.0 ) THEN
...
*
         CALL ZLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0
         CALL LA_TEST_ZGEESX( 'N', SORT, ZSLECT, 'V', N, HT, LDA, SDIM1,
     &     WT,
     $                VS1, LDVS, RCNDE1, RCNDV1, WORK, LWORK, RWORK,
     $                BWORK, IINFO )
         IF( IINFO.NE.0 ) THEN
...
*
         CALL ZLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0      
         CALL LA_TEST_ZGEESX( 'N', 'S', ZSLECT, 'B', N, HT, LDA, SDIM1,
     &     WT, VS1,
     $                LDVS, RCONDE, RCONDV, WORK, LWORK, RWORK, BWORK,
     $                IINFO )
         IF( IINFO.NE.0 ) THEN
