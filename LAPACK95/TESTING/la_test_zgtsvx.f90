SUBROUTINE LA_TEST_ZGTSVX( FACT, TRANS, N, NRHS, DL, D, DU, DLF, DF,&
...
!  .. Array Arguments ..
      ...
      COMPLEX(WP), INTENT(IN) :: B(1:LDB,1:NRHS)
      COMPLEX(WP), INTENT(IN) :: DL(1:N-1), D(1:N), DU(1:N-1)
      COMPLEX(WP), INTENT(INOUT) :: DF(1:N), DLF(1:N-1), DU2(1:N-2), &
     &  DUF(1:N-1)
...
!  .. Parameters ..
      ...
      CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_ZGTSVX'
!  .. Common blocks ..
      INTEGER :: INFOTC
