SUBROUTINE LA_TEST_DGELSY( M, N, NRHS, A, LDA, B, LDB, JPVT, RCOND, RANK, WORK, LWORK, INFO )
!
...
!  .. Parameters ..
      ...
      CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_DGELSY'
!  .. Common blocks ..
      INTEGER :: INFOTC
