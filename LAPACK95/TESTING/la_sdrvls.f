...
*     .. External Subroutines ..
      EXTERNAL           ALAERH, ALAHD, ALASVM, SAXPY, SERRLS,
     &                   LA_TEST_SGELS, LA_TEST_SGELSX,
     $                   LA_TEST_SGELSD, LA_TEST_SGELSS,
     &                   LA_TEST_SGELSY, SGEMM, SLACPY,
...
*
     ...
     $                                        COPYB, LDB, B, LDB )
                              END IF
                              SRNAMT = 'SGELS '
                              CALL LA_TEST_SGELS( TRANS, M, N, NRHS, A,
     &                                    LDA, B,
     $                                    LDB, WORK, LWORK, INFO )
                              IF( INFO.NE.0 )
...
*
                     SRNAMT = 'SGELSX'
                     INFO = INFO90
                     CALL LA_TEST_SGELSX( M, N, NRHS, A, LDA, B,
     &                            LDB, IWORK,
...
*
                        SRNAMT = 'SGELSY'
                        INFO = INFO90
                        CALL LA_TEST_SGELSY( M, N, NRHS, A, LDA, B,
     &                               LDB, IWORK,
...
*
     ...
     $                               LDB )
                        SRNAMT = 'SGELSS'
                        INFO = INFO90
                        CALL LA_TEST_SGELSS( M, N, NRHS, A, LDA, B,
     &                               LDB, S,
...
*
                        SRNAMT = 'SGELSD'
                        INFO = INFO90
                        CALL LA_TEST_SGELSD( M, N, NRHS, A, LDA, B,
     &                               LDB, S,
