SUBROUTINE LA_TEST_ZPPSVX( FACT, UPLO, N, NRHS, AP, AFP, EQUED, S, B, &
...
!  .. Array Arguments ..
      COMPLEX(WP), INTENT(INOUT) :: AP(N*(N+1)/2), B(1:LDB,1:NRHS), &
     &  AFP(1: N*(N+1)/2)
...
!  .. Parameters ..
      ...
      CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_ZPPSVX'
!  .. Common blocks ..
      INTEGER :: INFOTC
