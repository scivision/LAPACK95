...
*     .. External Subroutines ..
     ...
     $                   CLATMS, CPBEQU, LA_TEST_CPBSV,  LA_TEST_CPBSVX,
     &                   CPBT01,
     $                   CPBT02, CPBT05, CPBTRF, CPBTRS, CSWAP, XLAENV
*     ..
*     .. Intrinsic Functions ..
...
*
                           SRNAMT = 'CPBSV '
                           INFO = INFO90
                           CALL LA_TEST_CPBSV( UPLO, N, KD, NRHS, AFAC,
     $                                LDAB, X, LDA, INFO )
*
...
*
                        SRNAMT = 'CPBSVX'
                        INFO = INFO90
                        CALL LA_TEST_CPBSVX( FACT, UPLO, N, KD, NRHS,
     &                               A, LDAB,
