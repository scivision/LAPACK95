...
*     .. External Subroutines ..
      EXTERNAL           LA_TEST_CGEEVX, CGET22, CLACPY, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      ...
      IINFO = 0
      CALL LA_TEST_CGEEVX( BALANC, 'V', 'V', SENSE, N, H, LDA, W, VL,
     &             LDVL, VR,
...
*
         CALL CLACPY( 'F', N, N, A, LDA, H, LDA )
         IINFO = 0
         CALL LA_TEST_CGEEVX( BALANC, 'N', 'N', SENSE, N, H, LDA,
     &                W1, CDUM, 1,
...
*
         CALL CLACPY( 'F', N, N, A, LDA, H, LDA )
         IINFO = 0
         CALL LA_TEST_CGEEVX( BALANC, 'N', 'V', SENSE, N, H, LDA, W1,
     &                CDUM, 1,
...
*
         CALL CLACPY( 'F', N, N, A, LDA, H, LDA )
         IINFO = 0
         CALL LA_TEST_CGEEVX( BALANC, 'V', 'N', SENSE, N, H, LDA,
     &                W1, LRE,
...
*
      IF( COMP ) THEN
        CALL CLACPY( 'F', N, N, A, LDA, H, LDA )
        IINFO = 0
         CALL LA_TEST_CGEEVX( 'N', 'V', 'V', 'B', N, H, LDA, W, VL,
     &                LDVL, VR,
