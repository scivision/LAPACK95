...
*     .. External Subroutines ..
     ...
     $                   ZPOT05, LA_TEST_ZSYSV, LA_TEST_ZSYSVX, ZSYT01,
     $                   ZSYT02, ZSYTRF, ZSYTRI
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
      CHARACTER*6        SRNAMT
...
*
                     SRNAMT = 'ZSYSV '
                     INFO = INFO90
                     CALL LA_TEST_ZSYSV( UPLO, N, NRHS, AFAC, LDA,
...
*
      SRNAMT = 'ZSYSVX'
      INFO  = INFO90
        CALL LA_TEST_ZSYSVX( FACT, UPLO, N, NRHS, A, LDA, AFAC, LDA,
