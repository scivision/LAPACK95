SUBROUTINE LA_TEST_DGEGS(JOBVSL, JOBVSR, N, A, LDA, B, LDB, ALPHAR, ALPHAI, BETA, VSL, LDVSL, VSR, LDVSR, WORK, LWORK, INFO)
!
...
!  .. Parameters ..
   ...
   CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_DGEGS '
!  .. Common blocks ..
   INTEGER :: INFOTC
