SUBROUTINE LA_TEST_ZGEEV( JOBVL, JOBVR, N, A, LDA, W, VL, LDVL, VR, LDVR, WORK, LWORK, RWORK, INFO )
!
...
!  .. Parameters ..
   ...
   CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_ZGEEV '
!  .. Common blocks ..
   INTEGER :: INFOTC
...
!  .. Executable Statements ..
   ...
   IF (LSAME(IJOBVR, 'V')) THEN
     IF (LSAME(IJOBVL,'V')) THEN
       CALL LA_GEEV(A(1:IA1, 1:IA2), W(1:IW), &
