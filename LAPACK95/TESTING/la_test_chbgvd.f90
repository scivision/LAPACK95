SUBROUTINE LA_TEST_CHBGVD( JOBZ, UPLO, N, KAB, KBB, AB, LDAB, BB, LDBB, W, Z, LDZ, WORK, LWORK, RWORK, LRWORK, IWORK, LIWORK, INFO )
!
...
!  .. Parameters ..
      ...
      CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_CHBGVD'
!  .. Common blocks ..
      INTEGER :: INFOTC
