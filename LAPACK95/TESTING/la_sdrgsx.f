...
*     .. External Subroutines ..
      EXTERNAL           ALASVM, SGESVD, SGET51, SGET53,
     &                   LA_TEST_SGGESX, SLABAD,
...
*
         BDSPAC = MAX( 3*NSIZE*NSIZE / 2, 5*NSIZE*NSIZE / 2-2 )
...
*
                  LINFO = 0
                  CALL LA_TEST_SGGESX( 'V', 'V', 'S', SLCTSX, SENSE,
     &                         MPLUSN, AI,
...
*
      LINFO = 0
      CALL LA_TEST_SGGESX( 'V', 'V', 'S', SLCTSX, 'B', MPLUSN, AI, LDA,
     &             BI, LDA,
