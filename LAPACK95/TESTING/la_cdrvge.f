...
*     .. External Subroutines ..
      EXTERNAL           ALADHD, ALAERH, ALASVM, CERRVX, LA_TEST_CGEEQU,
     $                   LA_TEST_CGESV, LA_TEST_CGESVX, CGET01, CGET02,
     $                   CGET04, CGET07, LA_TEST_CGETRF, LA_TEST_CGETRI,
     $                   CLACPY, CLAQGE, CLARHS, CLASET, CLATB4,
     $                   CLATMS, XLAENV
*     ..
*     .. Intrinsic Functions ..
...
*
                       INFO = INFO90
                       CALL LA_TEST_CGEEQU( N, N, AFAC, LDA, S,
...
*
                     INFO = 0
                     CALL LA_TEST_CGETRF( N, N, AFAC, LDA, IWORK, INFO )
*
...
*
                     ...
                     INFO = 0
                     CALL LA_TEST_CGETRI( N, A, LDA, IWORK, WORK,
     &                                     LWORK, INFO )
*
...
*
                        SRNAMT = 'CGESV '
                        INFO = INFO90
                        CALL LA_TEST_CGESV( N, NRHS, AFAC, LDA, IWORK,
     $                                      X, LDA, INFO )
*
...
*
                     SRNAMT = 'CGESVX'
                     INFO = INFO90
                     CALL LA_TEST_CGESVX( FACT, TRANS, N, NRHS, A, LDA,
     &                            AFAC,
