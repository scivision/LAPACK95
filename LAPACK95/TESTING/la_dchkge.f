     ...
     $                   X, XACT, WORK, RWORK, IWORK, NOUT, INFO90)
*
...
*     .. Scalar Arguments ..
      LOGICAL            TSTERR
      INTEGER            NM, NMAX, NN, NNB, NNS, NOUT, INFO90
...
*     .. External Subroutines ..
      EXTERNAL           ALAERH, ALAHD, ALASUM, DERRGE, LA_TEST_DGECON,
     $                   LA_TEST_DGERFS, DGET01, DGET02, DGET03, DGET04,
     $                   DGET07, LA_TEST_DGETRF, LA_TEST_DGETRI,
     $                   LA_TEST_DGETRS, DLACPY, DLARHS, DLASET, DLATB4,
     $                   DLATMS, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
                  ...
                  SRNAMT = 'DGETRF'
                  INFO = INFO90
                  CALL LA_TEST_DGETRF( M, N, AFAC, LDA, IWORK, INFO )
*
...
*
                  IF( M.EQ.N .AND. INFO.EQ.0 ) THEN
                     ...
                     INFO = INFO90
                     CALL LA_TEST_DGETRI( N, AINV, LDA, IWORK, WORK,
     $                                LWORK, INFO )
*
...
*
                        ...
                        CALL LA_TEST_DGETRS( TRANS, N, NRHS, AFAC, LDA,
     $                                    IWORK, X, LDA, INFO )
...
*
                        SRNAMT = 'DGERFS'
                        INFO = INFO90
                        CALL LA_TEST_DGERFS( TRANS, N, NRHS, A, LDA,
     $                           AFAC, LDA, IWORK, B, LDA, X, LDA,
...
*
   70             CONTINUE
                  DO 80 ITRAN = 1, 2
                     ...
                     CALL DLACPY( 'Full', M, N, A, LDA, AFAC, LDA )
                     INFO = INFO90
                     CALL LA_TEST_DGECON( NORM, N, AFAC, LDA, ANORM,
...
*
                     IF( RESULT( 8 ).GE.THRESH ) THEN
                        IF( NFAIL.EQ.0 .AND. NERRS.EQ.0 )
     $                     CALL ALAHD( NOUT, PATH )
                        WRITE( NOUT, FMT = 9997 )NORM, N, NB, IMAT, 8,
     $                     RESULT( 8 )
                        NFAIL = NFAIL + 1
                     END IF
                     NRUN = NRUN + 1
