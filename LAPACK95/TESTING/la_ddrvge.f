...
*     .. Scalar Arguments ..
      LOGICAL            TSTERR
      INTEGER            NMAX, NN, NOUT, NRHS, INFO90
...
*     .. External Subroutines ..
      EXTERNAL           ALADHD, ALAERH, ALASVM, DERRVX, LA_TEST_DGEEQU,
     $                   LA_TEST_DGESV,  LA_TEST_DGESVX, DGET01, DGET02,
     $                   DGET04, DGET07, LA_TEST_DGETRF, LA_TEST_DGETRI,
     $                   DLACPY, DLAQGE, DLARHS, DLASET, DLATB4, DLATMS,
     $                   XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, MAX
...
*
                       INFO = INFO90
                       CALL LA_TEST_DGEEQU( N, N, AFAC, LDA, S,
...
*
                     INFO = 0
                     CALL LA_TEST_DGETRF( N, N, AFAC, LDA, IWORK, INFO )
*
...
*
                     ...
                     INFO = 0
                     CALL LA_TEST_DGETRI( N, A, LDA, IWORK, WORK,
     $                                     LWORK, INFO )
*
...
*
                        SRNAMT = 'DGESV '
                        INFO = INFO90
                        CALL LA_TEST_DGESV( N, NRHS, AFAC, LDA, IWORK,
     $                                          X, LDA, INFO )
*
...
*
                     SRNAMT = 'DGESVX'
                     INFO = INFO90
                     CALL LA_TEST_DGESVX( FACT, TRANS, N, NRHS, A, LDA,
     $                         AFAC, LDA, IWORK, EQUED, S, S( N+1 ), B,
