SUBROUTINE LA_TEST_DSYEVD( JOBS, UPLO, N, A, LDA, W, WORK, LWORK, IWORK, LIWORK, INFO )
!
...
!  .. Parameters ..
   ...
   CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_DSYEVD'
!  .. Common blocks ..
   INTEGER :: INFOTC
...
!  .. Executable Statements ..
   ...
   CALL LA_SYEVD( A(1:IA1,1:IA2), W(1 :IW), IJOBS, IUPLO, INFO )
   CALL LA_AUX_AA01( I, CTEST, ETEST, SRNAMT )
 END SUBROUTINE LA_TEST_DSYEVD
