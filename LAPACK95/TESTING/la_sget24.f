...
*     .. External Subroutines ..
      EXTERNAL           SCOPY, LA_TEST_SGEESX, SGEMM, SLACPY, SORT01,
     &                   XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
         ...
         IINFO = 0
         CALL LA_TEST_SGEESX( 'V', SORT, SSLECT, 'N', N, H, LDA,
     &                SDIM, WR, WI,
...
*
         ...
         INFO = 0
         CALL LA_TEST_SGEESX( 'N', SORT, SSLECT, 'N', N, HT, LDA,
     &                SDIM, WRT,
...
*
         ...
         CALL SLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0
         CALL LA_TEST_SGEESX( 'V', SORT, SSLECT, 'B', N, HT, LDA,
     &                SDIM1, WRT,
...
*
      CALL SLACPY( 'F', N, N, A, LDA, HT, LDA )
      IINFO = 0
         CALL LA_TEST_SGEESX( 'N', SORT, SSLECT, 'B', N, HT, LDA,
     &                SDIM1, WRT,
...
*
      CALL SLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0
         CALL LA_TEST_SGEESX( 'V', SORT, SSLECT, 'E', N, HT, LDA,
     &                SDIM1, WRT,
     $                WIT, VS1, LDVS, RCNDE1, RCNDV1, WORK, LWORK,
     $                IWORK, LIWORK, BWORK, IINFO )
         IF( IINFO.NE.0 .AND. IINFO.NE.N+2 ) THEN
...
*
      CALL SLACPY( 'F', N, N, A, LDA, HT, LDA )
      IINFO = 0
         CALL LA_TEST_SGEESX( 'N', SORT, SSLECT, 'E', N, HT, LDA,
     &                SDIM1, WRT,
     $                WIT, VS1, LDVS, RCNDE1, RCNDV1, WORK, LWORK,
     $                IWORK, LIWORK, BWORK, IINFO )
         IF( IINFO.NE.0 .AND. IINFO.NE.N+2 ) THEN
...
*
      CALL SLACPY( 'F', N, N, A, LDA, HT, LDA )
      IINFO = 0
         CALL LA_TEST_SGEESX( 'V', SORT, SSLECT, 'V', N, HT, LDA,
     &                SDIM1, WRT,
     $                WIT, VS1, LDVS, RCNDE1, RCNDV1, WORK, LWORK,
     $                IWORK, LIWORK, BWORK, IINFO )
         IF( IINFO.NE.0 .AND. IINFO.NE.N+2 ) THEN
...
*
      CALL SLACPY( 'F', N, N, A, LDA, HT, LDA )
      IINFO = 0
         CALL LA_TEST_SGEESX( 'N', SORT, SSLECT, 'V', N, HT, LDA,
     &                SDIM1, WRT,
     $                WIT, VS1, LDVS, RCNDE1, RCNDV1, WORK, LWORK,
     $                IWORK, LIWORK, BWORK, IINFO )
         IF( IINFO.NE.0 .AND. IINFO.NE.N+2 ) THEN
...
*
         CALL SLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0
         CALL LA_TEST_SGEESX( 'N', 'S', SSLECT, 'B', N, HT, LDA,
     &                SDIM1, WRT,
     $                WIT, VS1, LDVS, RCONDE, RCONDV, WORK, LWORK,
     $                IWORK, LIWORK, BWORK, IINFO )
         IF( IINFO.NE.0 .AND. IINFO.NE.N+2 ) THEN
