...
*     .. External Subroutines ..
      EXTERNAL           ALASVM, SBDT01, LA_TEST_SGESDD,
     &                   LA_TEST_SGESVD, SLABAD,
     &                   SLACPY,
...
*
     ...
     $            CALL SLACPY( 'F', M, N, ASAV, LDA, A, LDA )
               SRNAMT = 'SGESVD'
               IINFO = 0
               CALL LA_TEST_SGESVD( 'A', 'A', M, N, A, LDA, SSAV, USAV,
     &           LDU, VTSAV, LDVT, WORK, LSWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
     ...
     $                   ( IJU.EQ.1 .AND. IJVT.EQ.1 ) )GO TO 70
                     ...
                     SRNAMT = 'SGESVD'
                     IINFO = 0
                     CALL LA_TEST_SGESVD( JOBU, JOBVT, M, N, A, LDA, S,
     &                 U, LDU, VT, LDVT, WORK, LSWORK, IINFO )
*
*                    Compare U
*
                     DIF = ZERO
...
*
               ...
               SRNAMT = 'SGESDD'
               IINFO = 0
               CALL LA_TEST_SGESDD( 'A', M, N, A, LDA, SSAV, USAV,
     &                      LDU, VTSAV,
...
*
               ...
               DO 110 IJQ = 0, 2
                  ...
                  SRNAMT = 'SGESDD'
                  IINFO = 0
                  CALL LA_TEST_SGESDD( JOBQ, M, N, A, LDA, S, U, LDU,
     &                         VT, LDVT,
