...
*     .. External Subroutines ..
     ...
     $                   CLATMS, CPPEQU, LA_TEST_CPPSV, LA_TEST_CPPSVX,
     &                   CPPT01, CPPT02, CPPT05, CPPTRF, CPPTRI
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
      CHARACTER*6        SRNAMT
...
*
                        ...
                        INFO = INFO90
*
                        CALL LA_TEST_CPPSV( UPLO, N, NRHS, AFAC, X,
     &                    LDA, INFO )
*
...
*
                     SRNAMT = 'CPPSVX'
                     INFO = INFO90
                     CALL LA_TEST_CPPSVX( FACT, UPLO, N, NRHS, A,
     &                            AFAC, EQUED,
