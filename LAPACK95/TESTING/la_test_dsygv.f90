SUBROUTINE LA_TEST_DSYGV( ITYPE, JOBZ, UPLO, N, A, LDA, B, LDB, W, WORK, LWORK, INFO )
!
...
!  .. Parameters ..
   CHARACTER(LEN=8),  PARAMETER :: SRNAME = 'LA_SYGV '
   CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_DSYGV '
!  .. Common blocks ..
   INTEGER :: INFOTC
...
!  .. Executable Statements ..
   ...
   CALL LA_SYGV( A(1:IA1,1:IA2), B(1:IB1, 1:IB2), W(1 :IW), &
&    IITYPE, IJOBZ, IUPLO, INFO )
   
   CALL LA_AUX_AA01( I, CTEST, ETEST, SRNAMT )
 END SUBROUTINE LA_TEST_DSYGV
