...
*     .. External Subroutines ..
      EXTERNAL           ALASVM, CGET52, LA_TEST_CGGEV, CLACPY, CLARFG,
     &                   CLASET,
...
*
            ...
            IERR = 0
            CALL LA_TEST_CGGEV( 'V', 'V', N, S, LDA, T, LDA, ALPHA,
     &                  BETA, Q,
...
*
            ...
            CALL CLACPY( ' ', N, N, B, LDA, T, LDA )
            IERR = 0
            CALL LA_TEST_CGGEV( 'N', 'N', N, S, LDA, T, LDA,
     &                  ALPHA1, BETA1, Q,
     $                  LDQ, Z, LDQ, WORK, LWORK, RWORK, IERR )
            IF( IERR.NE.0 .AND. IERR.NE.N+1 ) THEN
               RESULT( 1 ) = ULPINV
...
*
            ...
            CALL CLACPY( ' ', N, N, B, LDA, T, LDA )
            IERR = 0
            CALL LA_TEST_CGGEV( 'V', 'N', N, S, LDA, T, LDA, ALPHA1,
     &                  BETA1, QE,
...
*
            ...
            CALL CLACPY( ' ', N, N, B, LDA, T, LDA )
            IERR = 0
            CALL LA_TEST_CGGEV( 'N', 'V', N, S, LDA, T, LDA, ALPHA1,
     &                  BETA1, Q,
