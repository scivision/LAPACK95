...
*     .. External Subroutines ..
      EXTERNAL           ALASVM, DGET52, LA_TEST_DGGEV, DLABAD, DLACPY,
...
*
            ...
            IERR = 0
            CALL LA_TEST_DGGEV( 'V', 'V', N, S, LDA, T, LDA,
     &                  ALPHAR, ALPHAI,
...
*
            ...
            CALL DLACPY( ' ', N, N, B, LDA, T, LDA )
            IERR = 0
            CALL LA_TEST_DGGEV( 'N', 'N', N, S, LDA, T, LDA,
     &                  ALPHR1, ALPHI1,
...
*
            ...
            CALL DLACPY( ' ', N, N, B, LDA, T, LDA )
              IERR = 0
            CALL LA_TEST_DGGEV( 'V', 'N', N, S, LDA, T, LDA,
     &                  ALPHR1, ALPHI1,
...
*
            ...
            CALL DLACPY( ' ', N, N, B, LDA, T, LDA )
              IERR = 0
            CALL LA_TEST_DGGEV( 'N', 'V', N, S, LDA, T, LDA,
     &                  ALPHR1, ALPHI1,
