...
*     .. External Subroutines ..
      EXTERNAL ALAESM, CHKXER, DGBCON, DGBEQU, DGBRFS, DGBTF2, DGBTRF,
     $         DGBTRS, LA_TEST_DGECON, LA_TEST_DGEEQU, LA_TEST_DGERFS,
     $         DGETF2, LA_TEST_DGETRF, LA_TEST_DGETRI, LA_TEST_DGETRS
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
      CHARACTER*6        SRNAMT
...
*
         ...
         INFOT = 2
         INFO  = 201
         CALL LA_TEST_DGETRF( NMAX, NMAX, A, NMAX, IP, INFO )
...
*
         ...
         DO I = 1, 2
            ...
            DO J = 1, IN(I)
               INFO = J + 100*I
               CALL LA_TEST_DGETRI( NMAX, A, NMAX, IP, W, LW, INFO )
...
*
         ...
         DO I = 1, 4
            ...
            DO J = 1, IN(I)
               DO NRHS = 1, 2
                  INFO = J + 100*I
                  CALL LA_TEST_DGETRS( 'N', NMAX, NRHS, A, NMAX,
     $                 IP, B, NMAX, INFO )
...
*
         ...
         DO I = 1, 8
            ...
            DO J = 1, IN(I)
               DO NRHS = 1, 2
                  INFO = J + 100*I
                  CALL LA_TEST_DGERFS( 'N', NMAX, NRHS, A, NMAX, AF,
...
*
         ...
         DO I = 1, 4
            IF( I.NE.3 ) THEN
               ...
               DO J = 1, IN(I)
                  INFO = J + 100*I
                  CALL LA_TEST_DGECON( 'I', NMAX, A, NMAX, ANRM, RCOND,
     $                 W, IW, INFO )
...
*
         ...
         DO I = 2, 3
            ...
            DO J = 1, IN(I)
              INFO = J + 100*I
               CALL LA_TEST_DGEEQU( NMAX, NMAX+1, A, NMAX, R1, R2,
