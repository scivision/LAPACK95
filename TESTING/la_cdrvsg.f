...
*     .. External Subroutines ..
      EXTERNAL           LA_TEST_CHBGV, LA_TEST_CHBGVD, LA_TEST_CHBGVX,
     &                   LA_TEST_CHEGV,
     &                   LA_TEST_CHEGVD, LA_TEST_CHEGVX, LA_TEST_CHPGV,
     &                   LA_TEST_CHPGVD, LA_TEST_CHPGVX,
     &                   CLACPY, CLASET, CLATMR,
...
*
                  IINFO = 0
                  CALL LA_TEST_CHEGV( IBTYPE, 'V', UPLO, N, Z, LDZ, BB,
     &              LDB, D,
...
*
                  IINFO = 0
                  CALL LA_TEST_CHEGVD( IBTYPE, 'V', UPLO, N, Z, LDZ,
     &                         BB, LDB, D,
...
*
                  IINFO = 0
                  CALL LA_TEST_CHEGVX( IBTYPE, 'V', 'A', UPLO, N,
     &                         AB, LDA, BB,
...
*
                  ...
                  VU = ANORM
                  IINFO = 0
                  CALL LA_TEST_CHEGVX( IBTYPE, 'V', 'V', UPLO, N,
     &                         AB, LDA, BB,
     $                         LDB, VL, VU, IL, IU, ABSTOL, M, D, Z,
     $                         LDZ, WORK, NWORK, RWORK, IWORK( N+1 ),
     $                         IWORK, IINFO )
...
*
                  IINFO = 0
                  CALL LA_TEST_CHEGVX( IBTYPE, 'V', 'I', UPLO, N, AB,
     &                         LDA, BB,
     $                         LDB, VL, VU, IL, IU, ABSTOL, M, D, Z,
     $                         LDZ, WORK, NWORK, RWORK, IWORK( N+1 ),
     $                         IWORK, IINFO )
...
*
                  IINFO = 0
                  CALL LA_TEST_CHPGV( IBTYPE, 'V', UPLO, N, AP, BP, D,
     &              Z, LDZ,
     $                        WORK, RWORK, IINFO )
                  IF( IINFO.NE.0 ) THEN
...
*
                  IINFO = 0
                  CALL LA_TEST_CHPGVD( IBTYPE, 'V', UPLO, N, AP, BP,
     &                         D, Z, LDZ,
     $                         WORK, NWORK, RWORK, LRWORK, IWORK,
     $                         LIWORK, IINFO )
                  IF( IINFO.NE.0 ) THEN
...
*
                  INFO = 0
                  CALL LA_TEST_CHPGVX( IBTYPE, 'V', 'A', UPLO, N, AP,
     &                         BP, VL,
...
*
                  ...
                  VU = ANORM
                  INFO = 0
                  CALL LA_TEST_CHPGVX( IBTYPE, 'V', 'V', UPLO, N, AP,
     &                         BP, VL,
     $                         VU, IL, IU, ABSTOL, M, D, Z, LDZ, WORK,
     $                         RWORK, IWORK( N+1 ), IWORK, INFO )
                  IF( IINFO.NE.0 ) THEN
...
*
                  INFO = 0
                  CALL LA_TEST_CHPGVX( IBTYPE, 'V', 'I', UPLO, N, AP,
     &                         BP, VL,
     $                         VU, IL, IU, ABSTOL, M, D, Z, LDZ, WORK,
     $                         RWORK, IWORK( N+1 ), IWORK, INFO )
                  IF( IINFO.NE.0 ) THEN
...
*
                     IINFO = 0
                     CALL LA_TEST_CHBGV( 'V', UPLO, N, KA, KB, AB, LDA,
     &                 BB, LDB,
...
*
                     IINFO = 0
                     CALL LA_TEST_CHBGVD( 'V', UPLO, N, KA, KB, AB,
     &                            LDA, BB,
...
*
                     IINFO = 0
                     CALL LA_TEST_CHBGVX( 'V', 'A', UPLO, N, KA, KB,
     &                            AB, LDA,
...
*
                     ...
                     VU = ANORM
                     IINFO = 0
                     CALL LA_TEST_CHBGVX( 'V', 'V', UPLO, N, KA, KB,
     &                            AB, LDA,
     $                            BB, LDB, BP, MAX( 1, N ), VL, VU, IL,
     $                            IU, ABSTOL, M, D, Z, LDZ, WORK, RWORK,
     $                            IWORK( N+1 ), IWORK, IINFO )
...
*
                     IINFO = 0
                     CALL LA_TEST_CHBGVX( 'V', 'I', UPLO, N, KA, KB,
     &                            AB, LDA,
     $                            BB, LDB, BP, MAX( 1, N ), VL, VU, IL,
     $                            IU, ABSTOL, M, D, Z, LDZ, WORK, RWORK,
     $                            IWORK( N+1 ), IWORK, IINFO )
