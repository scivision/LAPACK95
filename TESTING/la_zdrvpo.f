...
*     .. External Subroutines ..
     ...
     $                   ZLATMS, ZPOEQU, LA_TEST_ZPOSV,  LA_TEST_ZPOSVX,
     $                   ZPOT01, ZPOT02, ZPOT05, ZPOTRF, ZPOTRI
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
      CHARACTER*6        SRNAMT
...
*
                        SRNAMT = 'ZPOSV '
                        INFO = INFO90
                        CALL LA_TEST_ZPOSV( UPLO, N, NRHS, AFAC, LDA,
     $                    X, LDA, INFO )
*
...
*
                     SRNAMT = 'ZPOSVX'
                     INFO = INFO90
               CALL LA_TEST_ZPOSVX( FACT, UPLO, N, NRHS, A, LDA, AFAC,
