     ...
     $                   E, B, X, XACT, WORK, RWORK, NOUT, INFO90)
*
...
*     .. External Subroutines ..
     ...
     $                   DLACPY, DLAPTM, DLARNV, DLASET, DLATB4,
     $                   DLATMS, LA_TEST_DPTSV, LA_TEST_DPTSVX, DPTT01,
     $                   DPTT02, DPTT05, DPTTRF, DPTTRS, DSCAL
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, MAX
*     ..
...
*
                  SRNAMT = 'DPTSV '
                  INFO = INFO90
                  CALL LA_TEST_DPTSV( N, NRHS, D( N+1 ), E( N+1 ), X,
     $                                LDA, INFO )
*
...
*
               SRNAMT = 'DPTSVX'
               INFO = INFO90
               CALL LA_TEST_DPTSVX( FACT, N, NRHS, D, E, D( N+1 ),
     &           E( N+1 ), B, LDA, X, LDA, RCOND, RWORK,
     &           RWORK( NRHS+1 ),  WORK, INFO )
*
