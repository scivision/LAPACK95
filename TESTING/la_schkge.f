...
*     .. External Subroutines ..
      EXTERNAL           ALAERH, ALAHD, ALASUM, SERRGE, LA_TEST_SGECON,
     $                   LA_TEST_SGERFS, SGET01, SGET02, SGET03, SGET04,
     $                   SGET07, LA_TEST_SGETRF, LA_TEST_SGETRI,
     $                   LA_TEST_SGETRS, SLACPY, SLARHS, SLASET,
     $                   SLATB4,SLATMS, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
                  ...
                  SRNAMT = 'SGETRF'
                  INFO = INFO90
                  CALL LA_TEST_SGETRF( M, N, AFAC, LDA, IWORK, INFO )
*
...
*
                  IF( M.EQ.N .AND. INFO.EQ.0 ) THEN
                     ...
                     INFO = INFO90
                     CALL LA_TEST_SGETRI( N, AINV, LDA, IWORK, WORK,
     $                                     LWORK, INFO )
*
...
*
                        ...
                        SRNAMT = 'SGETRS'
                        INFO = INFO90
                        CALL LA_TEST_SGETRS( TRANS, N, NRHS, AFAC, LDA,
     $                                IWORK, X, LDA, INFO )
*
...
*
                        SRNAMT = 'SGERFS'
                        INFO = INFO90
                        CALL LA_TEST_SGERFS( TRANS, N, NRHS, A, LDA,
     $                               AFAC, LDA,
...
*
   70             CONTINUE
                  DO 80 ITRAN = 1, 2
                     ...
                     INFO = INFO90 
                     CALL LA_TEST_SGECON( NORM, N, AFAC, LDA, ANORM,
