...
*     .. External Subroutines ..
      EXTERNAL           ALASVM, DBDT01, LA_TEST_DGESDD, LA_TEST_DGESVD,
     &                   DLABAD, DLACPY,
...
*
     ...
     $            CALL DLACPY( 'F', M, N, ASAV, LDA, A, LDA )
               SRNAMT = 'DGESVD'
               IINFO = 0
               CALL LA_TEST_DGESVD( 'A', 'A', M, N, A, LDA, SSAV,
     &           USAV, LDU, VTSAV, LDVT, WORK, LSWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
     ...
     $                   ( IJU.EQ.1 .AND. IJVT.EQ.1 ) )GO TO 70
                     ...
                     SRNAMT = 'DGESVD'
                     IINFO = 0
                     CALL LA_TEST_DGESVD( JOBU, JOBVT, M, N, A, LDA,
     &                 S, U, LDU, VT, LDVT, WORK, LSWORK, IINFO )
*
*                    Compare U
*
                     DIF = ZERO
...
*
               ...
               SRNAMT = 'DGESDD'
               IINFO = 0
               CALL LA_TEST_DGESDD( 'A', M, N, A, LDA, SSAV, USAV,
     &           LDU, VTSAV,LDVT, WORK, LSWORK, IWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               ...
               DO 110 IJQ = 0, 2
                  ...
                  SRNAMT = 'DGESDD'
                  IINFO = 0
                  CALL LA_TEST_DGESDD( JOBQ, M, N, A, LDA, S, U, LDU,
     &              VT, LDVT, WORK, LSWORK, IWORK, IINFO )
*
*                 Compare U
*
                  DIF = ZERO
