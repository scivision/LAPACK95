SUBROUTINE LA_TEST_CGBSV( N, KL, KU, NRHS, AB, LDAB, IPIV, B, LDB, INFO )
!
...
!  .. Array Arguments ..
      ...
      COMPLEX(WP), INTENT(INOUT) :: AB(1:LDAB,1:N), B(1:LDB,1:N)
!  .. Parameters ..
      CHARACTER(LEN=8),  PARAMETER :: SRNAME = 'LA_GBSV '
      CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_CGBSV '
!  .. Common blocks ..
      INTEGER :: INFOTC
