...
*
      ...
      IINFO = INFO
      CALL LA_TEST_DGEEVX( BALANC, 'V', 'V', SENSE, N, H, LDA, WR,
     &             WI, VL, LDVL,
...
*
         CALL DLACPY( 'F', N, N, A, LDA, H, LDA )
              IINFO = 0
         CALL LA_TEST_DGEEVX( BALANC, 'N', 'N', SENSE, N, H, LDA, WR1,
     &     WI1, DUM, 1, DUM, 1, ILO1, IHI1, SCALE1, ABNRM1, RCNDE1,
...
*
         CALL DLACPY( 'F', N, N, A, LDA, H, LDA )
              IINFO = 0
         CALL LA_TEST_DGEEVX( BALANC, 'N', 'V', SENSE, N, H, LDA, WR1,
     &     WI1, DUM, 1, LRE, LDLRE, ILO1, IHI1, SCALE1, ABNRM1, RCNDE1,
     $     RCNDV1, WORK, LWORK, IWORK, IINFO )
         IF( IINFO.NE.0 ) THEN
            RESULT( 1 ) = ULPINV
            IF( JTYPE.NE.22 ) THEN
...
*
         CALL DLACPY( 'F', N, N, A, LDA, H, LDA )
              IINFO = 0
         CALL LA_TEST_DGEEVX( BALANC, 'V', 'N', SENSE, N, H, LDA, WR1,
     &     WI1, LRE, LDLRE, DUM, 1, ILO1, IHI1, SCALE1, ABNRM1, RCNDE1,
     $     RCNDV1, WORK, LWORK, IWORK, IINFO )
         IF( IINFO.NE.0 ) THEN
            RESULT( 1 ) = ULPINV
            IF( JTYPE.NE.22 ) THEN
...
*
      IF( COMP ) THEN
         CALL DLACPY( 'F', N, N, A, LDA, H, LDA )
              IINFO = 0
         CALL LA_TEST_DGEEVX( 'N', 'V', 'V', 'B', N, H, LDA, WR, WI,
