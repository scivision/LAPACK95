...
*     .. External Subroutines ..
     ...
     $                   ZGET04, LA_TEST_ZGTSV, LA_TEST_ZGTSVX, ZGTT01,
     &                   ZGTT02,
     $                   ZGTT05, ZGTTRF, ZGTTRS, ZLACPY, ZLAGTM, ZLARNV,
...
*
                     SRNAMT = 'ZGTSV '
                     INFO = INFO90
                     CALL LA_TEST_ZGTSV( N, NRHS, AF, AF( M+1 ),
     $                                 AF( N+M+1 ), X,  LDA, INFO )
*
...
*
                SRNAMT = 'ZGTSVX'
               INFO = INFO90
               CALL LA_TEST_ZGTSVX( FACT, TRANS, N, NRHS, A, A( M+1 ),
