...
*     .. External Subroutines ..
      EXTERNAL           ALADHD, ALAERH, ALASVM, CERRVX, CGET04,
     $                   LA_TEST_CHESV, LA_TEST_CHESVX, CHET01, CHETRF,
     &                   CHETRI,
     $                   CLACPY, CLAIPD, CLARHS, CLASET, CLATB4, CLATMS,
     $                   CPOT02, CPOT05, XLAENV
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
      CHARACTER*6        SRNAMT
...
*
                     SRNAMT = 'CHESV '
                     INFO = INFO90
                     CALL LA_TEST_CHESV( UPLO, N, NRHS, AFAC, LDA,
     $                            IWORK, X, LDA, WORK, LWORK, INFO )
*
...
*
                  SRNAMT = 'CHESVX'
                  INFO = INFO90
                  CALL LA_TEST_CHESVX( FACT, UPLO, N, NRHS, A, LDA,
     &                         AFAC, LDA,
