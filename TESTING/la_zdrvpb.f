...
*     .. External Subroutines ..
     ...
     $                   ZLATB4, ZLATMS, ZPBEQU, LA_TEST_ZPBSV,
     $                   LA_TEST_ZPBSVX,
     $                   ZPBT01, ZPBT02, ZPBT05, ZPBTRF, ZPBTRS, ZSWAP
*     ..
*     .. Intrinsic Functions ..
...
*
                           SRNAMT = 'ZPBSV '
                           INFO = INFO90
                           CALL LA_TEST_ZPBSV( UPLO, N, KD, NRHS, AFAC,
     $                       LDAB, X, LDA, INFO )
*
...
*
                        SRNAMT = 'ZPBSVX'
                        INFO = INFO90
                        CALL LA_TEST_ZPBSVX( FACT, UPLO, N, KD, NRHS, A,
     &                               LDAB,
