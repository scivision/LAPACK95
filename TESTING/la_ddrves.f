...
*     .. External Subroutines ..
      EXTERNAL           LA_TEST_DGEES, DHST01, DLABAD, DLACPY, DLASET,
     &                   DLASUM,
...
*
                  ...
                  IINFO = 0
                  CALL LA_TEST_DGEES( 'V', SORT, DSLECT, N, H, LDA,
     &              SDIM, WR, WI, VS, LDVS, WORK, NNWORK, BWORK, IINFO)
...
*
                  ...
                  IINFO = 0
                  CALL LA_TEST_DGEES( 'N', SORT, DSLECT, N, HT, LDA,
     &              SDIM, WRT, WIT, VS, LDVS, WORK, NNWORK, BWORK,
     $              IINFO )
                  IF( IINFO.NE.0 .AND. IINFO.NE.N+2 ) THEN
