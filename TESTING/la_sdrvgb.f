...
*     .. External Subroutines ..
      EXTERNAL           ALADHD, ALAERH, ALASVM, SERRVX, SGBEQU,
     $                   LA_TEST_SGBSV,  SGBSVX, SGBT01, SGBT02, SGBT05,
     $                   SGBTRF, SGBTRS, SGET04, SLACPY, SLAQGB, SLARHS,
     $                   SLASET, SLATB4, SLATMS, XLAENV
*     ..
*     .. Intrinsic Functions ..
...
*
                              SRNAMT = 'SGBSV '
                              INFO = INFO90
                              CALL LA_TEST_SGBSV( N, KL, KU, NRHS, AFB,
...
*
                           SRNAMT = 'SGBSVX'
                           INFO = 0
                           CALL LA_TEST_SGBSVX( FACT, TRANS, N, KL, KU,
     &                                  NRHS, A,
