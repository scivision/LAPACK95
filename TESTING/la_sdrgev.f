...
*     .. External Subroutines ..
      EXTERNAL           ALASVM, SGET52, LA_TEST_SGGEV, SLABAD, SLACPY,
...
*
            ...
            IERR = 0
            CALL LA_TEST_SGGEV( 'V', 'V', N, S, LDA, T, LDA,
     &                  ALPHAR, ALPHAI,
...
*
            ...
            CALL SLACPY( ' ', N, N, B, LDA, T, LDA )
            IERR = 0
            CALL LA_TEST_SGGEV( 'N', 'N', N, S, LDA, T, LDA,
     &                  ALPHR1, ALPHI1,
...
*
            ...
            CALL SLACPY( ' ', N, N, B, LDA, T, LDA )
            IERR = 0
            CALL LA_TEST_SGGEV( 'V', 'N', N, S, LDA, T, LDA, ALPHR1,
     &                  ALPHI1,
...
*
            ...
            CALL SLACPY( ' ', N, N, B, LDA, T, LDA )
            IERR = 0
            CALL LA_TEST_SGGEV( 'N', 'V', N, S, LDA, T, LDA, ALPHR1,
     &                  ALPHI1,
