...
*     .. External Subroutines ..
      EXTERNAL           ALAERH, ALAHD, ALASUM, CERRGE, LA_TEST_CGECON,
     $                   LA_TEST_CGERFS, CGET01, CGET02, CGET03, CGET04,
     $                   CGET07, LA_TEST_CGETRF, LA_TEST_CGETRI,
     $                   LA_TEST_CGETRS, CLACPY, CLARHS, CLASET, CLATB4,
     $                   CLATMS, XLAENV
*     ..
*     .. Intrinsic Functions ..
...
*
                  ...
                  SRNAMT = 'CGETRF'
                  INFO = INFO90
                  CALL LA_TEST_CGETRF( M, N, AFAC, LDA, IWORK, INFO )
*
...
*
                  IF( M.EQ.N .AND. INFO.EQ.0 ) THEN
                     ...
                     INFO = INFO90
                     CALL LA_TEST_CGETRI( N, AINV, LDA, IWORK, WORK,
     &                                   LWORK,  INFO )
*
...
*
                        ...
                        SRNAMT = 'CGETRS'
                        INFO = INFO90
                        CALL LA_TEST_CGETRS( TRANS, N, NRHS, AFAC, LDA,
     $                    IWORK, X, LDA, INFO )
*
...
*
                        SRNAMT = 'CGERFS'
                        INFO = INFO90
                        CALL LA_TEST_CGERFS( TRANS, N, NRHS, A, LDA,
     $                               AFAC, LDA,
...
*
   70             CONTINUE
                  DO 80 ITRAN = 1, 2
                     ...
                     CALL CLACPY( 'Full', M, N, A, LDA, AFAC, LDA )
                     INFO = INFO90
                     CALL LA_TEST_CGECON( NORM, N, AFAC, LDA, ANORM,
