SUBROUTINE LA_TEST_SGEGV(JOBVL, JOBVR, N, A, LDA, B, LDB, ALPHAR, ALPHAI, BETA, VL, LDVL, VR, LDVR, WORK, LWORK, INFO)
!
...
!  .. Parameters ..
   ...
   CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_SGEGV '
!  .. Common blocks ..
   INTEGER :: INFOTC
...
!  .. Executable Statements ..
   ...
   IF (LSAME(IJOBVL,'V')) THEN
     IF (LSAME (IJOBVR, 'V')) THEN
       CALL LA_GEGV( A(1:IA1,1:IA2), B(1:IB1, 1:IB2), ALPHAR(1: IALPHAR), &
