...
*     .. External Subroutines ..
      EXTERNAL           ALAERH, ALAHD, ALASUM, XLAENV, ZERRGE,
     $                   LA_TEST_ZGECON, LA_TEST_ZGERFS, ZGET01, ZGET02,
     $                   ZGET03, ZGET04, ZGET07, LA_TEST_ZGETRF,
     $                   LA_TEST_ZGETRI, LA_TEST_ZGETRS, ZLACPY, ZLARHS,
     $                   ZLASET, ZLATB4, ZLATMS
*     ..
*     .. Intrinsic Functions ..
...
*
                  ...
                  SRNAMT = 'ZGETRF'
                  INFO = INFO90
                  CALL LA_TEST_ZGETRF( M, N, AFAC, LDA, IWORK, INFO )
*
...
*
                  IF( M.EQ.N .AND. INFO.EQ.0 ) THEN
                     ...
                     INFO = INFO90
                     CALL LA_TEST_ZGETRI( N, AINV, LDA, IWORK, WORK,
     $                                    LWORK,  INFO )
*
...
*
                        ...
                        SRNAMT = 'ZGETRS'
                        INFO = INFO90
                        CALL LA_TEST_ZGETRS( TRANS, N, NRHS, AFAC, LDA,
     $                              IWORK, X, LDA, INFO )
*
...
*
                        SRNAMT = 'ZGERFS'
                        INFO = INFO90
                        CALL LA_TEST_ZGERFS( TRANS, N, NRHS, A, LDA,
     &                               AFAC, LDA,
...
*
   70             CONTINUE
                  DO 80 ITRAN = 1, 2
                     ...
                     CALL ZLACPY( 'Full', M, N, A, LDA, AFAC, LDA )
                     INFO = INFO90 
                     CALL LA_TEST_ZGECON( NORM, N, AFAC, LDA, ANORM,
