...
*     .. External Subroutines ..
     ...
     $                   LA_TEST_CGTSV, LA_TEST_CGTSVX, CGTT01, CGTT02,
     &                   CGTT05,
     $                   CGTTRF, CGTTRS, CLACPY, CLAGTM, CLARNV, CLASET,
     $                   CLATB4, CLATMS, CSSCAL
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          CMPLX, MAX
*     ..
...
*
                     SRNAMT = 'CGTSV '
                     INFO = INFO90
                     CALL LA_TEST_CGTSV( N, NRHS, AF, AF( M+1 ),
     $                 AF( N+M+1 ), X, LDA, INFO )
*
...
*
                  SRNAMT = 'CGTSVX'
                  INFO = INFO90
                  CALL LA_TEST_CGTSVX( FACT, TRANS, N, NRHS, A,
     &                         A( M+1 ),
