...
*     .. External Subroutines ..
     ...
     $                   LA_TEST_ZGEEQU, LA_TEST_ZGESV, LA_TEST_ZGESVX,
     $                   ZGET01, ZGET02, ZGET04, ZGET07,
     $                   LA_TEST_ZGETRF, LA_TEST_ZGETRI, ZLACPY, ZLAQGE,
     $                   ZLARHS, ZLASET, ZLATB4, ZLATMS
*     ..
*     .. Intrinsic Functions ..
...
*
                       INFO = INFO90
                       CALL LA_TEST_ZGEEQU( N, N, AFAC, LDA, S,
...
*
                     INFO = 0
                     CALL LA_TEST_ZGETRF( N, N, AFAC, LDA, IWORK, INFO )
*
...
*
                     ...
                     INFO = 0
                     CALL LA_TEST_ZGETRI( N, A, LDA, IWORK, WORK,
     &                                  LWORK, INFO )
*
...
*
                        SRNAMT = 'ZGESV '
                        INFO = INFO90
                        CALL LA_TEST_ZGESV( N, NRHS, AFAC, LDA, IWORK,
     $                                         X, LDA, INFO )
*
...
*
                     SRNAMT = 'ZGESVX'
                     INFO = INFO90
                     CALL LA_TEST_ZGESVX( FACT, TRANS, N, NRHS, A, LDA,
     &                            AFAC,
