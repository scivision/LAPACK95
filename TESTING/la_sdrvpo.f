...
*     .. External Subroutines ..
     ...
     $                   LA_TEST_SPOSV,  LA_TEST_SPOSVX, SPOT01, SPOT02,
     &                   SPOT05, SPOTRF, SPOTRI, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
                        SRNAMT = 'SPOSV '
                        INFO = INFO90
                        CALL LA_TEST_SPOSV( UPLO, N, NRHS, AFAC, LDA,
     $                              X, LDA, INFO )
*
...
*
                     SRNAMT = 'SPOSVX'
                     INFO = INFO90
                     CALL LA_TEST_SPOSVX( FACT, UPLO, N, NRHS, A, LDA,
     &                            AFAC,
