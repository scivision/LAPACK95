SUBROUTINE LA_TEST_SSBGV( JOBZ, UPLO, N, KA, KB, AB, LDAB, BB, LDBB, W, Z, LDZ, WORK, INFO )
!
...
!  .. Parameters ..
   CHARACTER(LEN=8),  PARAMETER :: SRNAME = 'LA_SBGV '
   CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_SSBGV '
!  .. Common blocks ..
   INTEGER :: INFOTC
...
!  .. Executable Statements ..
   ...
   IF (LSAME(IJOBZ, 'V')) THEN
     CALL LA_SBGV( AB(1:IAB1, 1: IAB2), BB(1:IBB1, 1:IBB2), W(1 :IW), &
