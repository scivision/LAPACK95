...
*     .. External Subroutines ..
      EXTERNAL           LA_TEST_DGEEV, DGET22, DLABAD, DLACPY, DLASET,
...
*
               ...
               IINFO = 0
               CALL LA_TEST_DGEEV( 'V', 'V', N, H, LDA, WR, WI, VL,
...
*
               CALL DLACPY( 'F', N, N, A, LDA, H, LDA )
               IINFO = 0
               CALL LA_TEST_DGEEV( 'N', 'N', N, H, LDA, WR1, WI1, DUM,
     $           1, DUM, 1, WORK, NNWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
                  RESULT( 1 ) = ULPINV
...
*
               CALL DLACPY( 'F', N, N, A, LDA, H, LDA )
              IINFO = 0
               CALL LA_TEST_DGEEV( 'N', 'V', N, H, LDA, WR1, WI1, DUM,
     &           1, LRE, LDLRE, WORK, NNWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
                  RESULT( 1 ) = ULPINV
...
*
               CALL DLACPY( 'F', N, N, A, LDA, H, LDA )
               IINFO = 0
               CALL LA_TEST_DGEEV( 'V', 'N', N, H, LDA, WR1, WI1,
