SUBROUTINE LA_TEST_SSBEVD( JOBS, UPLO, N, KD, AB, LDAB, W, Z, LDZ, WORK, LWORK, IWORK, LIWORK, INFO )
!
...
!  .. Parameters ..
  ...
  CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_SSBEVD'
!  .. Common blocks ..
  INTEGER :: INFOTC
