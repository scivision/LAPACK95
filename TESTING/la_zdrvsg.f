...
*     .. External Subroutines ..
      EXTERNAL           DLABAD, DLAFTS, DLASUM, XERBLA, LA_TEST_ZHBGV,
     &                   LA_TEST_ZHBGVD,
     $                   LA_TEST_ZHBGVX, LA_TEST_ZHEGV, LA_TEST_ZHEGVD,
     $                   LA_TEST_ZHEGVX, LA_TEST_ZHPGV, ZHPGVD,
...
*
                  IINFO = 0
                  CALL LA_TEST_ZHEGV( IBTYPE, 'V', UPLO, N, Z, LDZ, BB,
     &              LDB, D,
...
*
                  IINFO = 0
                  CALL LA_TEST_ZHEGVD( IBTYPE, 'V', UPLO, N, Z, LDZ,
     &              BB, LDB, D,
...
*
                  IINFO  = 0
                  CALL LA_TEST_ZHEGVX( IBTYPE, 'V', 'A', UPLO, N, AB,
     &                         LDA, BB,
...
*
                  ...
                  VU = ANORM
                  IINFO = 0
                  CALL LA_TEST_ZHEGVX( IBTYPE, 'V', 'V', UPLO, N, AB,
     &                         LDA, BB,
     $                         LDB, VL, VU, IL, IU, ABSTOL, M, D, Z,
     $                         LDZ, WORK, NWORK, RWORK, IWORK( N+1 ),
     $                         IWORK, IINFO )
...
*
                  IINFO = 0
                  CALL LA_TEST_ZHEGVX( IBTYPE, 'V', 'I', UPLO, N, AB,
     &                         LDA, BB,
     $                         LDB, VL, VU, IL, IU, ABSTOL, M, D, Z,
     $                         LDZ, WORK, NWORK, RWORK, IWORK( N+1 ),
     $                         IWORK, IINFO )
...
*
                  IINFO = 0
                  CALL LA_TEST_ZHPGV( IBTYPE, 'V', UPLO, N, AP, BP, D,
     &              Z, LDZ,
     $                        WORK, RWORK, IINFO )
                  IF( IINFO.NE.0 ) THEN
...
*
                  IINFO = 0
                  CALL LA_TEST_ZHPGVD( IBTYPE, 'V', UPLO, N, AP, BP,
     &                         D, Z, LDZ,
     $                         WORK, NWORK, RWORK, LRWORK, IWORK,
     $                         LIWORK, IINFO )
                  IF( IINFO.NE.0 ) THEN
...
*
                  IINFO = 0
                  CALL LA_TEST_ZHPGVX( IBTYPE, 'V', 'A', UPLO, N, AP,
     &                         BP, VL,
...
*
                  ...
                  VU = ANORM
                  IINFO = 0
                  CALL LA_TEST_ZHPGVX( IBTYPE, 'V', 'V', UPLO, N, AP,
     &                         BP, VL,
     $                         VU, IL, IU, ABSTOL, M, D, Z, LDZ, WORK,
     $                         RWORK, IWORK( N+1 ), IWORK, IINFO )
                  IF( IINFO.NE.0 ) THEN
...
*
                  IINFO = 0
                  CALL LA_TEST_ZHPGVX( IBTYPE, 'V', 'I', UPLO, N, AP,
     &                         BP, VL,
     $                         VU, IL, IU, ABSTOL, M, D, Z, LDZ, WORK,
     $                         RWORK, IWORK( N+1 ), IWORK, IINFO )
                  IF( IINFO.NE.0 ) THEN
...
*
                     IINFO = 0
                     CALL LA_TEST_ZHBGV( 'V', UPLO, N, KA, KB, AB, LDA,
     $                 BB, LDB, D, Z, LDZ, WORK, RWORK, IINFO )
                     IF( IINFO.NE.0 ) THEN
...
*
  ...
  430                   CONTINUE
                     END IF
*
                     CALL LA_TEST_ZHBGVD( 'V', UPLO, N, KA, KB, AB,
     &                 LDA, BB,
...
*
                     IINFO = 0
                     CALL LA_TEST_ZHBGVX( 'V', 'A', UPLO, N, KA, KB, AB,
     &                            LDA,
...
*
                     ...
                     VU = ANORM
                     IINFO = 0
                CALL LA_TEST_ZHBGVX( 'V', 'V', UPLO, N, KA, KB, AB, LDA,
     $                            BB, LDB, BP, MAX( 1, N ), VL, VU, IL,
     $                            IU, ABSTOL, M, D, Z, LDZ, WORK, RWORK,
     $                            IWORK( N+1 ), IWORK, IINFO )
                     IF( IINFO.NE.0 ) THEN
...
*
                     IINFO = 0
               CALL LA_TEST_ZHBGVX( 'V', 'I', UPLO, N, KA, KB, AB, LDA,
     $                            BB, LDB, BP, MAX( 1, N ), VL, VU, IL,
     $                            IU, ABSTOL, M, D, Z, LDZ, WORK, RWORK,
     $                            IWORK( N+1 ), IWORK, IINFO )
                     IF( IINFO.NE.0 ) THEN
