...
*     .. External Subroutines ..
     ...
     $                   SLATMS, LA_TEST_SSBGV, LA_TEST_SSBGVD,
     &                   LA_TEST_SSBGVX, SSGT01,
     $                   LA_TEST_SSPGV, LA_TEST_SSPGVD, LA_TEST_SSPGVX,
     &                   LA_TEST_SSYGV,
     $                   LA_TEST_SSYGVD, LA_TEST_SSYGVX, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
                  IINFO = 0
                  CALL LA_TEST_SSYGV( IBTYPE, 'V', UPLO, N, Z, LDZ, BB,
...
*
                  IINFO = 0
                  CALL LA_TEST_SSYGVD( IBTYPE, 'V', UPLO, N, Z, LDZ,
     &                         BB, LDB, D,
...
*
                  IINFO = 0
                  CALL LA_TEST_SSYGVX( IBTYPE, 'V', 'A', UPLO, N, AB,
     &                         LDA, BB,
...
*
                  ...
                  VU = ANORM
                  IINFO = 0
                  CALL LA_TEST_SSYGVX( IBTYPE, 'V', 'V', UPLO, N, AB,
     &                         LDA, BB,
     $                         LDB, VL, VU, IL, IU, ABSTOL, M, D, Z,
     $                         LDZ, WORK, NWORK, IWORK( N+1 ), IWORK,
     $                         IINFO )
...
*
                  IINFO = 0
                  CALL LA_TEST_SSYGVX( IBTYPE, 'V', 'I', UPLO, N, AB,
     &                         LDA, BB,
     $                         LDB, VL, VU, IL, IU, ABSTOL, M, D, Z,
     $                         LDZ, WORK, NWORK, IWORK( N+1 ), IWORK,
     $                         IINFO )
...
*
                IINFO = 0
                  CALL LA_TEST_SSPGV( IBTYPE, 'V', UPLO, N, AP, BP, D,
     &                    Z, LDZ, WORK, IINFO )
                  IF( IINFO.NE.0 ) THEN
...
*
                  IINFO = 0
                  CALL LA_TEST_SSPGVD( IBTYPE, 'V', UPLO, N, AP, BP,
     &                         D, Z, LDZ,
     $                         WORK, NWORK, IWORK, LIWORK, IINFO )
                  IF( IINFO.NE.0 ) THEN
...
*
                  IINFO = 0 
                  CALL LA_TEST_SSPGVX( IBTYPE, 'V', 'A', UPLO, N, AP,
     &                         BP, VL,
...
*
                  ...
                  VU = ANORM
                  IINFO = 0
                  CALL LA_TEST_SSPGVX( IBTYPE, 'V', 'V', UPLO, N, AP,
     &                         BP, VL,
     $                         VU, IL, IU, ABSTOL, M, D, Z, LDZ, WORK,
     $                         IWORK( N+1 ), IWORK, IINFO )
                  IF( IINFO.NE.0 ) THEN
...
*
                  IINFO = 0
                  CALL LA_TEST_SSPGVX( IBTYPE, 'V', 'I', UPLO, N, AP,
     &                         BP, VL,
     $                         VU, IL, IU, ABSTOL, M, D, Z, LDZ, WORK,
     $                         IWORK( N+1 ), IWORK, IINFO )
                  IF( IINFO.NE.0 ) THEN
...
*
                     IINFO = 0
                     CALL LA_TEST_SSBGV( 'V', UPLO, N, KA, KB, AB,
     &                 LDA,
     $                 BB, LDB, D, Z, LDZ, WORK, IINFO )
                     IF( IINFO.NE.0 ) THEN
...
*
                     IINFO = 0
                     CALL LA_TEST_SSBGVD( 'V', UPLO, N, KA, KB, AB,
     &                            LDA, BB,
...
*
                     IINFO = 0 
                     CALL LA_TEST_SSBGVX( 'V', 'A', UPLO, N, KA, KB,
     &                            AB, LDA,
...
*
                     ...
                     VU = ANORM
                     IINFO = 0
                     CALL LA_TEST_SSBGVX( 'V', 'V', UPLO, N, KA, KB,
     &                            AB, LDA,
     $                            BB, LDB, BP, MAX( 1, N ), VL, VU, IL,
     $                            IU, ABSTOL, M, D, Z, LDZ, WORK,
     $                            IWORK( N+1 ), IWORK, IINFO )
...
*
                     IINFO = 0
                     CALL LA_TEST_SSBGVX( 'V', 'I', UPLO, N, KA, KB,
     &                            AB, LDA,
     $                            BB, LDB, BP, MAX( 1, N ), VL, VU, IL,
     $                            IU, ABSTOL, M, D, Z, LDZ, WORK,
     $                            IWORK( N+1 ), IWORK, IINFO )
