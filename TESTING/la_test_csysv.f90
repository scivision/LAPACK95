SUBROUTINE LA_TEST_CSYSV( UPLO, N, NRHS, A, LDA, IPIV, B, LDB, WORK, LWORK, INFO )
!
...
!  .. Array Arguments ..
   ...
   COMPLEX(WP), INTENT(INOUT) :: A(1:LDA,1:N), B(1:LDB,1:NRHS), WORK(*)
!  .. Parameters ..
   CHARACTER(LEN=8),  PARAMETER :: SRNAME = 'LA_SYSV '
   CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_CSYSV '
!  .. Common blocks ..
   INTEGER :: INFOTC
