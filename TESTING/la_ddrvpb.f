...
*     .. External Subroutines ..
     ...
     $                   DPBEQU, LA_TEST_DPBSV,  LA_TEST_DPBSVX, DPBT01,
     $                   DPBT02,  DPBT05, DPBTRF, DPBTRS, DSWAP, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
                           SRNAMT = 'DPBSV '
                           INFO = INFO90
                           CALL LA_TEST_DPBSV( UPLO, N, KD, NRHS, AFAC,
     $                                      LDAB, X, LDA, INFO )
*
...
*
                        SRNAMT = 'DPBSVX'
                        INFO = 0
                        CALL LA_TEST_DPBSVX( FACT, UPLO, N, KD, NRHS,
     &                               A, LDAB,
