...
*     .. External Subroutines ..
      EXTERNAL           ALADHD, ALAERH, ALASVM, DERRVX, DGBEQU,
     $                   LA_TEST_DGBSV,  DGBSVX, DGBT01, DGBT02, DGBT05,
     $                   DGBTRF, DGBTRS, DGET04, DLACPY, DLAQGB, DLARHS,
     $                   DLASET, DLATB4, DLATMS, XLAENV
*     ..
*     .. Intrinsic Functions ..
...
*
                              SRNAMT = 'DGBSV '
                              INFO = INFO90
                              CALL LA_TEST_DGBSV( N, KL, KU, NRHS, AFB,
...
*
                           SRNAMT = 'DGBSVX'
                           INFO = 0
                           CALL LA_TEST_DGBSVX( FACT, TRANS, N, KL, KU,
     &                       NRHS, A,
