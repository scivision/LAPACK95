...
*     .. External Subroutines ..
      EXTERNAL           ALASVM, CBDT01, LA_TEST_CGESDD, LA_TEST_CGESVD,
     &                   CLACPY, CLASET, CLATMS, CUNT01, CUNT03, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $            CALL CLACPY( 'F', M, N, ASAV, LDA, A, LDA )
	       IINFO = 0
               CALL LA_TEST_CGESVD( 'A', 'A', M, N, A, LDA, SSAV, USAV,
     &           LDU, VTSAV, LDVT, WORK, LSWORK, RWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
     ...
     $                   ( IJU.EQ.1 .AND. IJVT.EQ.1 ) )GO TO 90
                     ...
                     CALL CLACPY( 'F', M, N, ASAV, LDA, A, LDA )
                     IINFO = 0
                     CALL LA_TEST_CGESVD( JOBU, JOBVT, M, N, A, LDA, S,
     &                 U, LDU, VT, LDVT, WORK, LSWORK, RWORK, IINFO )
*
*                    Compare U
*
                     DIF = ZERO
...
*
      CALL CLACPY( 'F', M, N, ASAV, LDA, A, LDA )
      IINFO = 0
               CALL LA_TEST_CGESDD( 'A', M, N, A, LDA, SSAV, USAV,
     &                      LDU, VTSAV,
...
*
               ...
               DO 130 IJQ = 0, 2
                  ...
                  CALL CLACPY( 'F', M, N, ASAV, LDA, A, LDA )
                  IINFO = 0
                  CALL LA_TEST_CGESDD( JOBQ, M, N, A, LDA, S, U, LDU,
     &                         VT, LDVT,
