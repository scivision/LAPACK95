...
*     .. External Subroutines ..
     ...
     $                   SLATMS, LA_TEST_SSBEV, LA_TEST_SSBEVD,
     &                   LA_TEST_SSBEVX, LA_TEST_SSPEV, LA_TEST_SSPEVD,
     $                   LA_TEST_SSPEVX, LA_TEST_SSTEV, LA_TEST_SSTEVD,
     &                   LA_TEST_SSTEVR, LA_TEST_SSTEVX, SSTT21,
     $                   SSTT22, LA_TEST_SSYEV, LA_TEST_SSYEVD,
     &                   LA_TEST_SSYEVR, LA_TEST_SSYEVX, SSYT21,
     $                   SSYT22, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
  ...
  130           CONTINUE
                ...
                IINFO = 0
                CALL LA_TEST_SSTEV( 'V', N, D1, D2, Z, LDU, WORK,
     &                 IINFO)
               IF( IINFO.NE.0 ) THEN
...
*
  ...
  160           CONTINUE
                IINFO = 0
                CALL LA_TEST_SSTEV( 'N', N, D3, D4, Z, LDU, WORK,
     &                  IINFO )
...
*
  ...
  200           CONTINUE
                IINFO = 0
               CALL LA_TEST_SSTEVX( 'V', 'A', N, D1, D2, VL, VU, IL,
     &                      IU, ABSTOL,
...
*
  ...
  230           CONTINUE
                IINFO = 0
               CALL LA_TEST_SSTEVX( 'N', 'A', N, D3, D4, VL, VU, IL,
     &                      IU, ABSTOL,
...
*
  ...
  270           CONTINUE
                IINFO = 0
               CALL LA_TEST_SSTEVR( 'V', 'A', N, D1, D2, VL, VU, IL,
     &                      IU, ABSTOL,
...
*
  ...
  300           CONTINUE
                IINFO = 0
               CALL LA_TEST_SSTEVR( 'N', 'A', N, D3, D4, VL, VU, IL,
     &                      IU, ABSTOL,
...
*
  ...
  340           CONTINUE
                IINFO = 0
               CALL LA_TEST_SSTEVX( 'V', 'I', N, D1, D2, VL, VU, IL,
     &                      IU, ABSTOL,
     $                      M2, WA2, Z, LDU, WORK, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
  ...
  370           CONTINUE
                IINFO = 0
               CALL LA_TEST_SSTEVX( 'N', 'I', N, D3, D4, VL, VU, IL,
     &                      IU, ABSTOL,
...
*
               IINFO = 0
               CALL LA_TEST_SSTEVX( 'V', 'V', N, D1, D2, VL, VU, IL,
     &                      IU, ABSTOL,
     $                      M2, WA2, Z, LDU, WORK, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
  ...
  430           CONTINUE
                IINFO = 0
               CALL LA_TEST_SSTEVX( 'N', 'V', N, D3, D4, VL, VU,
     &                      IL, IU, ABSTOL,
     $                      M3, WA3, Z, LDU, WORK, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
  ...
  460          CONTINUE
               IINFO = 0
               CALL LA_TEST_SSTEVD( 'V', N, D1, D2, Z, LDU, WORK,
...
*
  ...
  490          CONTINUE
               IINFO = 0
               CALL LA_TEST_SSTEVD( 'N', N, D3, D4, Z, LDU, WORK,
     &              LWEDC, IWORK, LIWEDC, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
  ...
  530           CONTINUE
                IINFO = 0
               CALL LA_TEST_SSTEVR( 'V', 'I', N, D1, D2, VL, VU, IL,
     &                      IU, ABSTOL,
     $                      M2, WA2, Z, LDU, IWORK, WORK, LWORK,
     $                      IWORK(2*N+1), LIWORK-2*N, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
  ...
  560           CONTINUE
                IINFO = 0
               CALL LA_TEST_SSTEVR( 'N', 'I', N, D3, D4, VL, VU, IL,
     &                      IU, ABSTOL,
...
*
               IINFO = 0
               CALL LA_TEST_SSTEVR( 'V', 'V', N, D1, D2, VL, VU, IL,
     &                      IU, ABSTOL,
     $                      M2, WA2, Z, LDU, IWORK, WORK, LWORK,
     $                      IWORK(2*N+1), LIWORK-2*N, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
  ...
  620           CONTINUE
                IINFO = 0
               CALL LA_TEST_SSTEVR( 'N', 'V', N, D3, D4, VL, VU, IL,
     &                      IU, ABSTOL,
     $                      M3, WA3, Z, LDU, IWORK, WORK, LWORK,
     $                      IWORK(2*N+1), LIWORK-2*N, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_SSYEV( 'V', UPLO, N, A, LDU, D1, WORK,
     &           LWORK,  IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 2
               IINFO = 0
               CALL LA_TEST_SSYEV( 'N', UPLO, N, A, LDU, D3, WORK,
     &                     LWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               IINFO = 0
               CALL LA_TEST_SSYEVX( 'V', 'A', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
...
*
               NTEST = NTEST + 2
               IINFO = 0
               CALL LA_TEST_SSYEVX( 'N', 'A', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
...
*
               ...
               CALL SLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO  = 0 
               CALL LA_TEST_SSYEVX( 'V', 'I', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M2, WA2, Z, LDU, WORK, LWORK, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               ...
               CALL SLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0
               CALL LA_TEST_SSYEVX( 'N', 'I', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
...
*
               ...
               CALL SLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0
               CALL LA_TEST_SSYEVX( 'V', 'V', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M2, WA2, Z, LDU, WORK, LWORK, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               ...
               CALL SLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0
               CALL LA_TEST_SSYEVX( 'N', 'V', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M3, WA3, Z, LDU, WORK, LWORK, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_SSPEV( 'V', UPLO, N, WORK, D1, Z, LDU, V,
     &           IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 2
               IINFO = 0
               CALL LA_TEST_SSPEV( 'N', UPLO, N, WORK, D3, Z, LDU,
     &           V, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               IINFO = 0
               CALL LA_TEST_SSPEVX( 'V', 'A', UPLO, N, WORK, VL,
     &                      VU, IL, IU,
...
*
               IINFO = 0
               CALL LA_TEST_SSPEVX( 'N', 'A', UPLO, N, WORK, VL, VU,
     &                      IL, IU,
...
*
               IINFO = 0
               CALL LA_TEST_SSPEVX( 'V', 'I', UPLO, N, WORK, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M2, WA2, Z, LDU, V, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               IINFO = 0
               CALL LA_TEST_SSPEVX( 'N', 'I', UPLO, N, WORK, VL, VU,
     &                      IL, IU,
...
*
               IINFO = 0
               CALL LA_TEST_SSPEVX( 'V', 'V', UPLO, N, WORK, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M2, WA2, Z, LDU, V, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               IINFO = 0
               CALL LA_TEST_SSPEVX( 'N', 'V', UPLO, N, WORK, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M3, WA3, Z, LDU, V, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_SSBEV( 'V', UPLO, N, KD, V, LDU, D1, Z,
     &                    LDU, WORK,  IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 2
               IINFO = 0
               CALL LA_TEST_SSBEV( 'N', UPLO, N, KD, V, LDU, D3, Z,
     &                LDU, WORK, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_SSBEVX( 'V', 'A', UPLO, N, KD, V, LDU, U,
     &                      LDU, VL,
...
*
               IINFO = 0
               CALL LA_TEST_SSBEVX( 'N', 'A', UPLO, N, KD, V, LDU, U,
     &                      LDU, VL,
...
*
               IINFO = 0
               CALL LA_TEST_SSBEVX( 'V', 'I', UPLO, N, KD, V, LDU, U,
     &                      LDU, VL,
...
*
               IINFO = 0
               CALL LA_TEST_SSBEVX( 'N', 'I', UPLO, N, KD, V, LDU, U,
     &                      LDU, VL,
     $                      VU, IL, IU, ABSTOL, M3, WA3, Z, LDU, WORK,
     $                      IWORK, IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               IINFO = 0 
               CALL LA_TEST_SSBEVX( 'V', 'V', UPLO, N, KD, V, LDU, U,
     &                      LDU, VL,
     $                      VU, IL, IU, ABSTOL, M2, WA2, Z, LDU, WORK,
     $                      IWORK, IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               IINFO = 0
               CALL LA_TEST_SSBEVX( 'N', 'V', UPLO, N, KD, V, LDU, U,
     &                      LDU, VL,
     $                      VU, IL, IU, ABSTOL, M3, WA3, Z, LDU, WORK,
     $                      IWORK, IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_SSYEVD( 'V', UPLO, N, A, LDU, D1, WORK,
     &           LWEDC,
     $                      IWORK, LIWEDC, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 2
               IINFO = 0
               CALL LA_TEST_SSYEVD( 'N', UPLO, N, A, LDU, D3, WORK,
     &           LWEDC,
     $                      IWORK, LIWEDC, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
              IINFO = 0
               CALL LA_TEST_SSPEVD( 'V', UPLO, N, WORK, D1, Z, LDU,
...
*
               NTEST = NTEST + 2
               IINFO = 0
               CALL LA_TEST_SSPEVD( 'N', UPLO, N, WORK, D3, Z, LDU,
     $                      WORK( INDX ), LWEDC-INDX+1, IWORK, LIWEDC,
     $                      IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_SSBEVD( 'V', UPLO, N, KD, V, LDU, D1, Z,
     &           LDU, WORK,
     $                      LWEDC, IWORK, LIWEDC, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 2
              IINFO = 0
               CALL LA_TEST_SSBEVD( 'N', UPLO, N, KD, V, LDU, D3, Z,
     &           LDU, WORK,
     $                      LWEDC, IWORK, LIWEDC, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               ...
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_SSYEVR( 'V', 'A', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
...
*
               NTEST = NTEST + 2
               IINFO = 0
               CALL LA_TEST_SSYEVR( 'N', 'A', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
...
*
               ...
               CALL SLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0
               CALL LA_TEST_SSYEVR( 'V', 'I', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M2, WA2, Z, LDU, IWORK, WORK, LWORK,
     $                      IWORK(2*N+1), LIWORK-2*N, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               ...
               CALL SLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0
               CALL LA_TEST_SSYEVR( 'N', 'I', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
...
*
               ...
               CALL SLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0 
               CALL LA_TEST_SSYEVR( 'V', 'V', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M2, WA2, Z, LDU, IWORK, WORK, LWORK,
     $                      IWORK(2*N+1), LIWORK-2*N, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               ...
               CALL SLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0
               CALL LA_TEST_SSYEVR( 'N', 'V', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M3, WA3, Z, LDU, IWORK, WORK, LWORK,
     $                      IWORK(2*N+1), LIWORK-2*N, IINFO )
               IF( IINFO.NE.0 ) THEN
