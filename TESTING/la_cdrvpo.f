...
*     .. External Subroutines ..
     ...
     $                   CPOEQU, LA_TEST_CPOSV,  LA_TEST_CPOSVX, CPOT01,
     &                   CPOT02, CPOT05, CPOTRF, CPOTRI, XLAENV
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
      CHARACTER*6        SRNAMT
...
*
                        SRNAMT = 'CPOSV '
                        INFO = INFO90
                        CALL LA_TEST_CPOSV( UPLO, N, NRHS, AFAC, LDA,
     $                                     X, LDA, INFO )
*
...
*
                     SRNAMT = 'CPOSVX'
                     INFO = INFO90
                     CALL LA_TEST_CPOSVX( FACT, UPLO, N, NRHS, A, LDA,
     &                            AFAC,
