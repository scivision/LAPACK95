SUBROUTINE LA_TEST_DSPGVD( ITYPE, JOBZ, UPLO, N, AP, BP, W, Z, LDZ, WORK, LWORK, IWORK, LIWORK, INFO )
!
...
!  .. Parameters ..
      ...
      CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_DSPGVD'
!  .. Common blocks ..
      INTEGER :: INFOTC
...
!  .. Executable Statements ..
      ...
      IF (LSAME(IJOBZ, 'V')) THEN
        CALL LA_SPGVD( AP(1:IAP), BP(1:IBP), W(1 :IW), &
