...
*     .. External Subroutines ..
     ...
     $                   SPBEQU, LA_TEST_SPBSV, LA_TEST_SPBSVX, SPBT01,
     &                   SPBT02,
     $                   SPBT05, SPBTRF, SPBTRS, SSWAP, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
                           SRNAMT = 'SPBSV '
                           INFO = INFO90
                           CALL LA_TEST_SPBSV( UPLO, N, KD, NRHS, AFAC,
     $                       LDAB, X, LDA, INFO )
*
...
*
                        SRNAMT = 'SPBSVX'
                        INFO = 0
                        CALL LA_TEST_SPBSVX( FACT, UPLO, N, KD, NRHS,
     &                               A, LDAB,
