...
*     .. External Subroutines ..
     ...
     $                   ZLARNV, ZLASET, ZLATB4, ZLATMS, LA_TEST_ZPTSV,
     $                   LA_TEST_ZPTSVX, ZPTT01, ZPTT02, ZPTT05, ZPTTRF,
     $                   ZPTTRS
*     ..
*     .. Intrinsic Functions ..
...
*
                  SRNAMT = 'ZPTSV '
                  INFO = INFO90
                  CALL LA_TEST_ZPTSV( N, NRHS, D( N+1 ), E( N+1 ), X,
     $                                LDA, INFO )
*
...
*
      SRNAMT = 'ZPTSVX'
      INFO = INFO90
        CALL LA_TEST_ZPTSVX( FACT, N, NRHS, D, E, D( N+1 ), E( N+1 ), B,
