...
*  =======
*
*  DCHKAA is the main test program for the DOUBLE PRECISION LAPACK90
         ...
         IF( TSTDRV ) THEN
           DO I = 1, 4
             ...
             ELSE
               NNRHS = MAX(2,NRHS)
             END IF
           CALL DDRVGE( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
         ...
         IF( TSTDRV ) THEN
           DO I=1, 4
             ...
             ELSE
               NNRHS = MAX(2, NRHS)
             END IF
             CALL DDRVGB( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR,
         ...
         IF( TSTDRV ) THEN
           DO I=1, 4
             ...
             ELSE
               NNRHS = MAX(2, NRHS)
             END IF
             CALL DDRVGT( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR,
     $                   A( 1, 1 ), A( 1, 2 ), B( 1, 1 ), B( 1, 2 ),
         ...
         IF( TSTDRV ) THEN
           DO I=1, 4
             ...
             ELSE
               NNRHS = MAX(2, NRHS)
             END IF
             CALL DDRVPO( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
     $                   B( 1, 2 ), B( 1, 3 ), B( 1, 4 ), S, WORK,
     $                   RWORK, IWORK, NOUT, I )
      END DO
         ...
         IF( TSTDRV ) THEN
           DO I=1, 4
             ...
             ELSE
               NNRHS = MAX(2, NRHS)
             END IF 
           CALL DDRVPP( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
     $                   B( 1, 2 ), B( 1, 3 ), B( 1, 4 ), S, WORK,
     $                   RWORK, IWORK, NOUT, I )
      END DO
...
*
         IF( TSTDRV ) THEN
           DO I=1, 4
             ...
             NNRHS = MAX(2, NRHS)
           END IF 
           CALL DDRVPB( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
     $                   B( 1, 2 ), B( 1, 3 ), B( 1, 4 ), S, WORK,
     $                   RWORK, IWORK, NOUT, I )
      END DO
         ...
         IF( TSTDRV ) THEN
           DO I=1, 4
             ...
             ELSE
               NNRHS = MAX(2, NRHS)
             END IF
             CALL DDRVPT( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
         ...
         IF( TSTDRV ) THEN
           DO I=1, 4
             ...
             ELSE
               NNRHS = MAX(2, NRHS)
             END IF
             CALL DDRVSY( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
         ...
         IF( TSTDRV ) THEN
           DO I=1, 4
             ...
             ELSE
               NNRHS = MAX(2, NRHS)
             END IF
             CALL DDRVSP( DOTYPE, NN, NVAL, NNRHS, THRESH, TSTERR, LDA,
     $                   A( 1, 1 ), A( 1, 2 ), A( 1, 3 ), B( 1, 1 ),
     $                   B( 1, 2 ), B( 1, 3 ), WORK, RWORK, IWORK,
     $                   NOUT, I )
      END DO
...
*
     ...
     $                   RWORK, RWORK( NMAX+1 ), WORK, IWORK, NOUT,1 )
         ELSE
            WRITE( NOUT, FMT = 9988 )PATH
         END IF
*
