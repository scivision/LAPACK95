...
*     .. External Subroutines ..
      EXTERNAL           DLABAD, DLASUM, XERBLA, LA_TEST_ZGEEV, ZGET22,
...
*
               ...
               IINFO = 0
               CALL LA_TEST_ZGEEV( 'V', 'V', N, H, LDA, W, VL, LDVL,
...
*
               CALL ZLACPY( 'F', N, N, A, LDA, H, LDA )
               IINFO = 0
               CALL LA_TEST_ZGEEV( 'N', 'N', N, H, LDA, W1, DUM,
     &           1, DUM, 1, WORK, NNWORK, RWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
                  RESULT( 1 ) = ULPINV
...
*
               CALL ZLACPY( 'F', N, N, A, LDA, H, LDA )
               IINFO = 0
               CALL LA_TEST_ZGEEV( 'N', 'V', N, H, LDA, W1, DUM, 1,
...
*
               CALL ZLACPY( 'F', N, N, A, LDA, H, LDA )
              IINFO = 0
               CALL LA_TEST_ZGEEV( 'V', 'N', N, H, LDA, W1, LRE, LDLRE,
