SUBROUTINE LA_TEST_ZGELSS( M, N, NRHS, A, LDA, B, LDB, S, RCOND, RANK, WORK, LWORK, RWORK, INFO )
!
...
!  .. Parameters ..
   ...
   CHARACTER(LEN=14), PARAMETER :: SRNAMT = 'LA_TEST_ZGELSS'
!  .. Common blocks ..
   INTEGER :: INFOTC
