...
*     .. External Subroutines ..
      EXTERNAL           ALASVM, DLABAD, DLAFTS, XERBLA, LA_TEST_ZHBEV,
     &  LA_TEST_ZHBEVD,
     $                   LA_TEST_ZHBEVX, LA_TEST_ZHEEV, LA_TEST_ZHEEVD,
     &  LA_TEST_ZHEEVR,
     &  LA_TEST_ZHEEVX,
     &  ZHET21,
     $                   ZHET22, LA_TEST_ZHPEV, LA_TEST_ZHPEVD,
     &  LA_TEST_ZHPEVX, ZLACPY,
     &  ZLASET,
     $                   ZLATMR, ZLATMS
*     ..
*     .. Intrinsic Functions ..
...
*
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_ZHEEVD( 'V', UPLO, N, A, LDU, D1,
     &           WORK, LWEDC, RWORK, LRWEDC, IWORK, LIWEDC, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 2
               IINFO = 0
               CALL LA_TEST_ZHEEVD( 'N', UPLO, N, A, LDU, D3,
     &           WORK, LWEDC, RWORK, LRWEDC, IWORK, LIWEDC, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               IINFO = 0
               CALL ZHEEVX( 'V', 'A', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
...
*
               IINFO = 0
               CALL ZHEEVX( 'V', 'I', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M2, WA2, Z, LDU, WORK, LWORK, RWORK,
     $                      IWORK, IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               IINFO = 0
               CALL ZHEEVX( 'N', 'I', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
...
*
               IINFO = 0
               CALL ZHEEVX( 'V', 'V', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M2, WA2, Z, LDU, WORK, LWORK, RWORK,
     $                      IWORK, IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               IINFO = 0
               CALL ZHEEVX( 'N', 'V', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M3, WA3, Z, LDU, WORK, LWORK, RWORK,
     $                      IWORK, IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               ...
               INDWRK = N*( N+1 ) / 2 + 1
               IINFO = 0
               CALL LA_TEST_ZHPEVD( 'V', UPLO, N, WORK, D1, Z, LDU,
...
*
               ...
               INDWRK = N*( N+1 ) / 2 + 1
               IINFO = 0
               CALL LA_TEST_ZHPEVD( 'N', UPLO, N, WORK, D3, Z, LDU,
     $                      WORK( INDWRK ), LWEDC, RWORK, LRWEDC, IWORK,
     $                      LIWEDC, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               IINFO = 0
               CALL LA_TEST_ZHPEVX( 'V', 'A', UPLO, N, WORK, VL, VU,
     &                      IL, IU,
...
*
               IINFO = 0
               CALL LA_TEST_ZHPEVX( 'N', 'A', UPLO, N, WORK, VL, VU,
     &                      IL, IU,
...
*
               IINFO =  0 
               CALL LA_TEST_ZHPEVX( 'V', 'I', UPLO, N, WORK, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M2, WA2, Z, LDU, V, RWORK, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               IINFO = 0
               CALL LA_TEST_ZHPEVX( 'N', 'I', UPLO, N, WORK, VL, VU,
     &                      IL, IU,
...
*
               IINFO = 0  
               CALL LA_TEST_ZHPEVX( 'V', 'V', UPLO, N, WORK, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M2, WA2, Z, LDU, V, RWORK, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               IINFO = 0
               CALL LA_TEST_ZHPEVX( 'N', 'V', UPLO, N, WORK, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M3, WA3, Z, LDU, V, RWORK, IWORK,
     $                      IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_ZHBEVD( 'V', UPLO, N, KD, V, LDU, D1, Z,
     &                      LDU, WORK,
...
*
               NTEST = NTEST + 2
               IINFO = 0
               CALL LA_TEST_ZHBEVD( 'N', UPLO, N, KD, V, LDU, D3, Z,
     &                      LDU, WORK,
     $                      LWEDC, RWORK, LRWEDC, IWORK, LIWEDC, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_ZHBEVX( 'V', 'A', UPLO, N, KD, V, LDU, U,
     &                      LDU, VL,
...
*
               IINFO = 0
               CALL LA_TEST_ZHBEVX( 'N', 'A', UPLO, N, KD, V, LDU, U,
     &                      LDU, VL,
...
*
               IINFO = 0
               CALL LA_TEST_ZHBEVX( 'V', 'I', UPLO, N, KD, V, LDU, U,
     &                      LDU, VL,
     $                      VU, IL, IU, ABSTOL, M2, WA2, Z, LDU, WORK,
     $                      RWORK, IWORK, IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
  ...
  830             CONTINUE
                END IF
                IINFO = 0
               CALL LA_TEST_ZHBEVX( 'N', 'I', UPLO, N, KD, V, LDU, U,
     &                      LDU, VL,
...
*
  ...
  880             CONTINUE
                END IF
                IINFO = 0
               CALL LA_TEST_ZHBEVX( 'V', 'V', UPLO, N, KD, V, LDU, U,
     &                      LDU, VL,
     $                      VU, IL, IU, ABSTOL, M2, WA2, Z, LDU, WORK,
     $                      RWORK, IWORK, IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
  ...
  920             CONTINUE
                END IF
                IINFO = 0
               CALL LA_TEST_ZHBEVX( 'N', 'V', UPLO, N, KD, V, LDU, U,
     &                      LDU, VL,
     $                      VU, IL, IU, ABSTOL, M3, WA3, Z, LDU, WORK,
     $                      RWORK, IWORK, IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_ZHEEV( 'V', UPLO, N, A, LDU, D1, WORK,
     &           LWORK, RWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 2
               IINFO = 0
               CALL LA_TEST_ZHEEV( 'N', UPLO, N, A, LDU, D3, WORK,
     &           LWORK, RWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               ...
               INDWRK = N*( N+1 ) / 2 + 1
               IINFO = 0
               CALL LA_TEST_ZHPEV( 'V', UPLO, N, WORK, D1, Z, LDU,
...
*
               ...
               INDWRK = N*( N+1 ) / 2 + 1
               IINFO = 0
               CALL LA_TEST_ZHPEV( 'N', UPLO, N, WORK, D3, Z, LDU,
     $                     WORK( INDWRK ), RWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_ZHBEV( 'V', UPLO, N, KD, V, LDU, D1, Z,
     &           LDU, WORK, RWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 2
               IINFO = 0
               CALL LA_TEST_ZHBEV( 'N', UPLO, N, KD, V, LDU, D3, Z,
     &           LDU, WORK, RWORK, IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               ...
               NTEST = NTEST + 1
               IINFO = 0
               CALL LA_TEST_ZHEEVR( 'V', 'A', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
...
*
      NTEST = NTEST + 2
      IINFO = 0
               CALL LA_TEST_ZHEEVR( 'N', 'A', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
...
*
               ...
               CALL ZLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0
               CALL LA_TEST_ZHEEVR( 'V', 'I', UPLO, N, A, LDU, VL, VU,
     &                     IL, IU,
     $                      ABSTOL, M2, WA2, Z, LDU, IWORK, WORK, LWORK,
     $                      RWORK, LRWORK, IWORK( 2*N+1 ), LIWORK-2*N,
     $                      IINFO )
...
*
               ...
               CALL ZLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0
               CALL LA_TEST_ZHEEVR( 'N', 'I', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
...
*
               ...
               CALL ZLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0
               CALL LA_TEST_ZHEEVR( 'V', 'V', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M2, WA2, Z, LDU, IWORK, WORK, LWORK,
     $                      RWORK, LRWORK, IWORK( 2*N+1 ), LIWORK-2*N,
     $                      IINFO )
...
*
               ...
               CALL ZLACPY( ' ', N, N, V, LDU, A, LDA )
               IINFO = 0
               CALL LA_TEST_ZHEEVR( 'N', 'V', UPLO, N, A, LDU, VL, VU,
     &                      IL, IU,
     $                      ABSTOL, M3, WA3, Z, LDU, IWORK, WORK, LWORK,
     $                      RWORK, LRWORK, IWORK( 2*N+1 ), LIWORK-2*N,
     $                      IINFO )
