...
*     .. External Subroutines ..
      EXTERNAL           CCOPY, LA_TEST_CGEESX, CGEMM, CLACPY,
     &                   CUNT01, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
         ...
         IINFO = 0
         CALL LA_TEST_CGEESX( 'V', SORT, CSLECT, 'N', N, H, LDA,
     &                SDIM, W, VS,
...
*
         ...
         IINFO = 0
         CALL LA_TEST_CGEESX( 'N', SORT, CSLECT, 'N', N, HT, LDA,
     &                SDIM, WT, VS,
     $                LDVS, RCONDE, RCONDV, WORK, LWORK, RWORK, BWORK,
     $                IINFO )
         IF( IINFO.NE.0 ) THEN
...
*
         ...
         CALL CLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0
         CALL LA_TEST_CGEESX( 'V', SORT, CSLECT, 'B', N, HT, LDA,
     &                SDIM1, WT,
...
*
         CALL CLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0
         CALL LA_TEST_CGEESX( 'N', SORT, CSLECT, 'B', N, HT, LDA,
     &                SDIM1, WT,
...
*
         CALL CLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0
         CALL LA_TEST_CGEESX( 'V', SORT, CSLECT, 'E', N, HT, LDA,
     &                SDIM1, WT,
     $                VS1, LDVS, RCNDE1, RCNDV1, WORK, LWORK, RWORK,
     $                BWORK, IINFO )
         IF( IINFO.NE.0 ) THEN
...
*
         CALL CLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0
         CALL LA_TEST_CGEESX( 'N', SORT, CSLECT, 'E', N, HT, LDA,
     &                SDIM1, WT,
     $                VS1, LDVS, RCNDE1, RCNDV1, WORK, LWORK, RWORK,
     $                BWORK, IINFO )
         IF( IINFO.NE.0 ) THEN
...
*
         CALL CLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0
         CALL LA_TEST_CGEESX( 'V', SORT, CSLECT, 'V', N, HT, LDA,
     &                SDIM1, WT,
     $                VS1, LDVS, RCNDE1, RCNDV1, WORK, LWORK, RWORK,
     $                BWORK, IINFO )
         IF( IINFO.NE.0 ) THEN
...
*
         CALL CLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0
         CALL LA_TEST_CGEESX( 'N', SORT, CSLECT, 'V', N, HT, LDA,
     &                SDIM1, WT,
     $                VS1, LDVS, RCNDE1, RCNDV1, WORK, LWORK, RWORK,
     $                BWORK, IINFO )
         IF( IINFO.NE.0 ) THEN
...
*
         CALL CLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0
         CALL LA_TEST_CGEESX( 'N', 'S', CSLECT, 'B', N, HT, LDA,
     &                SDIM1, WT, VS1,
     $                LDVS, RCONDE, RCONDV, WORK, LWORK, RWORK, BWORK,
     $                IINFO )
         IF( IINFO.NE.0 ) THEN
