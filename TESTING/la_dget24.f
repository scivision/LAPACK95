...
*     .. External Subroutines ..
      EXTERNAL           DCOPY, LA_TEST_DGEESX, DGEMM, DLACPY, DORT01,
     &                   XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
         ...
         IINFO = 0
         CALL LA_TEST_DGEESX( 'V', SORT, DSLECT, 'N', N, H, LDA, SDIM,
     &                WR, WI,
...
*
         ...
         IINFO = 0
         CALL LA_TEST_DGEESX( 'N', SORT, DSLECT, 'N', N, HT, LDA, SDIM,
     &                WRT,
...
*
         ...
         CALL DLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0
         CALL LA_TEST_DGEESX( 'V', SORT, DSLECT, 'B', N, HT, LDA,
     &                SDIM1, WRT,
...
*
      CALL DLACPY( 'F', N, N, A, LDA, HT, LDA )
      IINFO = 0
      CALL LA_TEST_DGEESX( 'N', SORT, DSLECT, 'B', N, HT, LDA, SDIM1,
     &                WRT,
...
*
      CALL DLACPY( 'F', N, N, A, LDA, HT, LDA )
      IINFO = 0
         CALL LA_TEST_DGEESX( 'V', SORT, DSLECT, 'E', N, HT, LDA, SDIM1,
     &                WRT,
     $                WIT, VS1, LDVS, RCNDE1, RCNDV1, WORK, LWORK,
     $                IWORK, LIWORK, BWORK, IINFO )
         IF( IINFO.NE.0 .AND. IINFO.NE.N+2 ) THEN
...
*
      CALL DLACPY( 'F', N, N, A, LDA, HT, LDA )
      IINFO = 0
         CALL LA_TEST_DGEESX( 'N', SORT, DSLECT, 'E', N, HT, LDA, SDIM1,
     &                WRT,
     $                WIT, VS1, LDVS, RCNDE1, RCNDV1, WORK, LWORK,
     $                IWORK, LIWORK, BWORK, IINFO )
         IF( IINFO.NE.0 .AND. IINFO.NE.N+2 ) THEN
...
*
      CALL DLACPY( 'F', N, N, A, LDA, HT, LDA )
      IINFO = 0
         CALL LA_TEST_DGEESX( 'V', SORT, DSLECT, 'V', N, HT, LDA, SDIM1,
     &                WRT,
     $                WIT, VS1, LDVS, RCNDE1, RCNDV1, WORK, LWORK,
     $                IWORK, LIWORK, BWORK, IINFO )
         IF( IINFO.NE.0 .AND. IINFO.NE.N+2 ) THEN
...
*
      CALL DLACPY( 'F', N, N, A, LDA, HT, LDA )
      IINFO = 0
         CALL LA_TEST_DGEESX( 'N', SORT, DSLECT, 'V', N, HT, LDA, SDIM1,
     &                WRT,
     $                WIT, VS1, LDVS, RCNDE1, RCNDV1, WORK, LWORK,
     $                IWORK, LIWORK, BWORK, IINFO )
         IF( IINFO.NE.0 .AND. IINFO.NE.N+2 ) THEN
...
*
         CALL DLACPY( 'F', N, N, A, LDA, HT, LDA )
         IINFO = 0
         CALL LA_TEST_DGEESX( 'N', 'S', DSLECT, 'B', N, HT, LDA, SDIM1,
     &                WRT,
     $                WIT, VS1, LDVS, RCONDE, RCONDV, WORK, LWORK,
     $                IWORK, LIWORK, BWORK, IINFO )
         IF( IINFO.NE.0 .AND. IINFO.NE.N+2 ) THEN
