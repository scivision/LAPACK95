...
use f77_lapack, only: ddisna, dgesvd
...
print '(a)','OK: lapack95, lapack svd comparison'

contains

subroutine lapack_svd(A,S)
!! SVD with plain LAPACK, showing it's easier with LAPACK95
