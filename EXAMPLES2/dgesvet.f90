...
!  .. "Executable Statements" ..
      WRITE (NOUT,*) 'DGESV ET_Example Program Results.'
...
!
      WRITE ( NOUT, * )'-----------------------------------------------'
      WRITE ( NOUT, * )
      WRITE ( NOUT, * )'Details of LA_DGESV LAPACK Subroutine Results.'
      WRITE ( NOUT, * )
!
      WRITE(NOUT,*)
...
!
      ...
      WRITE(NOUT,*) 'INFO = ', INFO
!
      END PROGRAM LA_DGESV_ET_EXAMPLE
