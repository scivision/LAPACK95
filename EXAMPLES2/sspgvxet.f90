...
!  .. EXECUTABLE STATEMENTS ..
  WRITE (NOUT,*) 'SSPGVX ET_Example Program Results.'
...
!
   WRITE ( NOUT, * )'---------------------------------------------------------'
   WRITE ( NOUT, * )
   WRITE ( NOUT, * )'Details of LA_SSPGVX LAPACK Subroutine Results.'
   WRITE ( NOUT, * )
!
   UPLO = 'U'
   WRITE(NOUT,*)
...
! ERROR 12
      ...
      WRITE(NOUT,*) 'INFO = ', INFO 
END PROGRAM LA_SSPGVX_ET_EXAMPLE
