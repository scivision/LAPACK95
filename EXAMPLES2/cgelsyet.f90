...
!  .. EXECUTABLE STATEMENTS ..
   WRITE (NOUT,*) 'CGELSY Example Program Results'
...
!
   WRITE ( NOUT, * )'--------------------------------------------'
   WRITE ( NOUT, * )
   WRITE ( NOUT, * )'Details of LA_CGELSY LAPACK Subroutine Results.'
   WRITE ( NOUT, * )
!
   WRITE (NOUT,*)
