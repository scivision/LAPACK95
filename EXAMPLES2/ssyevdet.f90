...
!
   WRITE(NOUT,*) 'SSYEVD ET_Example Program Results.'
...
!
   WRITE(NOUT,*) '---------------------------------------------------------'
   WRITE(NOUT,*)
   WRITE ( NOUT, * )'Details of LA_SSYEVD LAPACK Subroutine Results.'
   WRITE(NOUT,*)
!
   WRITE(NOUT,*)
...
! 
   ...
   WRITE(NOUT,FMT) W(:)
! 
END PROGRAM LA_SSYEVD_ET_EXAMPLE
