...
!  .. EXECUTABLE STATEMENTS ..
   WRITE (NOUT,*) 'ZGBSV ET_Example Program Results.'
...
!
   WRITE ( NOUT, * )'---------------------------------------------------------'
   WRITE ( NOUT, * )
      WRITE ( NOUT, * )'Details of LA_ZGBSV LAPACK Subroutine Results.'
   WRITE ( NOUT, * )
!
   WRITE(NOUT,*)
...
! 
   ...
   WRITE(NOUT,*) 'Pivots: ', IPIV
!
END PROGRAM LA_ZGBSV_ET_EXAMPLE
