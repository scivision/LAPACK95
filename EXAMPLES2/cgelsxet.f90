...
!  .. EXECUTABLE STATEMENTS ..
   WRITE (NOUT,*) 'CGELSX Example Program Results'
...
!
   WRITE ( NOUT, * )'--------------------------------------------'
   WRITE ( NOUT, * )
   WRITE ( NOUT, * )'Details of LA_CGELSX LAPACK Subroutine Results.'
   WRITE ( NOUT, * )
!
   WRITE (NOUT,*)
