...
!  .. EXECUTABLE STATEMENTS ..
   WRITE (NOUT,*) 'CGGES ET_Example Program Results.'
...
!
   WRITE ( NOUT, * )'---------------------------------------------------------'
   WRITE ( NOUT, * )
   WRITE ( NOUT, * )'Details of LA_CGGES LAPACK Subroutine Results.'
   WRITE ( NOUT, * )
!
   WRITE(NOUT,*)
...
!
   ...
   WRITE(NOUT,*) 'INFO = ', INFO
!
END PROGRAM LA_CGGES_ET_EXAMPLE
      LOGICAL FUNCTION SELECT( ALPHA, BETA)
      USE LA_PRECISION, ONLY: WP => SP
      COMPLEX(WP), INTENT(IN) :: ALPHA, BETA
      SELECT = .TRUE.
