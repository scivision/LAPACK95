...
!  .. EXECUTABLE STATEMENTS ..
   WRITE (NOUT,*) 'DGGEV ET_Example Program Results.'
...
!
   WRITE ( NOUT, * )'---------------------------------------------------------'
   WRITE ( NOUT, * )
   WRITE ( NOUT, * )'Details of LA_DGGEV LAPACK Subroutine Results.'
   WRITE ( NOUT, * )
!
   WRITE(NOUT,*)
...
!
   ...
   WRITE(NOUT,*) 'INFO = ', INFO
!
END PROGRAM LA_DGGEV_ET_EXAMPLE
