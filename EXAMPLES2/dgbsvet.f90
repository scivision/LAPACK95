...
!  .. EXECUTABLE STATEMENTS ..
   WRITE (NOUT,*) 'DGBSV ET_Example Program Results.'
...
!
   WRITE ( NOUT, * )'---------------------------------------------------------'
   WRITE ( NOUT, * )
      WRITE ( NOUT, * )'Details of LA_DGBSV LAPACK Subroutine Results.'
   WRITE ( NOUT, * )
!
   WRITE(NOUT,*)
...
! 
   ...
   WRITE(NOUT,*) 'Pivots: ', IPIV
!
END PROGRAM LA_DGBSV_ET_EXAMPLE
