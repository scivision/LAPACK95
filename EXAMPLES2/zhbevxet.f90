...
!  .. LOCAL ARRAYS ..
   ...
   COMPLEX(WP), ALLOCATABLE :: A(:,:), Z(:,:), Q(:,:)
!  .. EXECUTABLE STATEMENTS ..
   WRITE (NOUT,*) 'ZHBEVX ET_Example Program Results.'
...
!
   WRITE ( NOUT, * )'---------------------------------------------------------'
   WRITE ( NOUT, * )
   WRITE ( NOUT, * )'Details of LA_ZHBEVX LAPACK Subroutine Results.'
   WRITE ( NOUT, * )
!
   WRITE(NOUT,*)
...
!
   ...
   WRITE(NOUT,*) 'INFO = ', INFO
!
END!PROGRAM LA_ZHBEVX_ET_EXAMPLE
