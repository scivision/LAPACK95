...
!  .. EXECUTABLE STATEMENTS ..
   WRITE (NOUT,*) 'ZGBSVX ET_Example Program Results.'
...
!
   WRITE ( NOUT, * )'---------------------------------------------------------'
   WRITE ( NOUT, * )
   WRITE ( NOUT, * )'Details of LA_ZGBSVX LAPACK SUBROUTINE Results.'
   WRITE ( NOUT, * )
!
   WRITE(NOUT,*)
...
!
   ...
   WRITE(NOUT,*)'   INFO = ', INFO
!
END PROGRAM LA_ZGBSVX_ET_EXAMPLE
