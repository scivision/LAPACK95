...
!  .. EXECUTABLE STATEMENTS ..
   WRITE (NOUT,*) 'CSYSV ET_Example Program Results.'
...
!
   WRITE ( NOUT, * )'---------------------------------------------------------'
   WRITE ( NOUT, * )
   WRITE ( NOUT, * )'Details of LA_CSYSVX LAPACK Subroutine Results.'
   WRITE ( NOUT, * )
!
   WRITE(NOUT,*)
...
!
   ...
   WRITE(NOUT,*) 'RCOND = ', RCOND
!
END PROGRAM LA_CSYSVX_ET_EXAMPLE
