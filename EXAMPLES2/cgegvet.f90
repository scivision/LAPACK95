...
!  .. EXECUTABLE STATEMENTS ..
   WRITE (NOUT,*) 'CGEGV ET_Example Program Results.'
...
!
   WRITE ( NOUT, * )'---------------------------------------------------------'
   WRITE ( NOUT, * )
   WRITE ( NOUT, * )'Details of LA_CGEGV LAPACK Subroutine Results.'
   WRITE ( NOUT, * )
!
   WRITE(NOUT,*)
...
!
   ...
   WRITE(NOUT,*) 'INFO = ', INFO
!
END PROGRAM LA_CGEGV_ET_EXAMPLE
