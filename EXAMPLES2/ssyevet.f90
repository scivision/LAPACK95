...
!  .. EXECUTABLE STATEMENTS ..
   WRITE(NOUT,*) 'SSYEV ET_Example Program Results.'
...
!
   WRITE(NOUT,*) '---------------------------------------------------------'
   WRITE(NOUT,*)
   WRITE ( NOUT, * )'Details of LA_SSYEV LAPACK Subroutine Results.'
   WRITE(NOUT,*)
!
   WRITE(NOUT,*)
...
! 
   ...
   END DO
! 
END PROGRAM LA_SSYEV_ET_EXAMPLE
